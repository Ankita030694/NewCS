...
faq_data = [
    {
        "q": "Can I settle my 5 lakh loan for 1 lakh?",
        "a": "While technically possible in cases of extreme, documented financial ruin (like terminal illness or absolute bankruptcy), it is highly unlikely. Banks typically settle unsecured personal loans between 40% and 50% of the principal amount. A 20% settlement is extremely rare and requires extraordinary circumstances."
    },
    {
        "q": "Will the bank send police to my house for a 5 lakh default?",
        "a": "No. Defaulting on a personal loan is a civil matter, not a criminal offense. The bank cannot send the police to arrest you. They can only send authorized recovery agents, who must adhere to strict RBI guidelines regarding decorum and timing. If agents impersonate police, it is a criminal offense on their part."
    },
    {
        "q": "How long does it take to settle a 5 lakh loan?",
        "a": "The process is not instant. It typically takes 3 to 6 months of the account being in NPA status before the bank offers acceptable terms. You can read more about the <a href='/what-is-the-average-timeframe-for-completing-a-loan-settlement-process' class='text-blue-600 hover:underline'>average timeframe for a loan settlement process</a> to set realistic expectations."
    },
    {
        "q": "Can I get a home loan after settling a 5 lakh personal loan?",
        "a": "It will be extremely difficult for the next 5 to 7 years. A 'Settled' status severely damages your creditworthiness. Most mainstream banks will automatically reject your application. You might have to rely on specialized housing finance companies that charge significantly higher interest rates, and even then, approval is not guaranteed."
    },
    {
        "q": "Should I pay the settlement agent directly in cash?",
        "a": "Never. Under no circumstances should you hand over cash to an agent or transfer money to a personal UPI ID. The settlement amount must always be paid directly into your loan account or via a Demand Draft made in the exact name of the bank, as specified in the official settlement letter."
    },
    {
        "q": "What happens if I miss the settlement payment deadline?",
        "a": "If you fail to pay by the date specified in the settlement letter, the agreement becomes null and void. The bank will reinstate the full original outstanding amount, including all waived penal charges and interest, and aggressive recovery efforts will resume immediately. Your credibility for future negotiations will be destroyed."
    },
    {
        "q": "Is the waived amount considered taxable income?",
        "a": "Yes, under Section 41(1) of the Income Tax Act, the amount of debt waived by the bank during a settlement is considered a 'benefit or perquisite' arising from business or profession. You are legally required to declare this waived amount as income and pay applicable taxes on it."
    }
]
...
reviews_data = [
    {
        ...
        "location": "Mumbai",
        "rating": 5,
        "text": "I lost my job and couldn't pay my 5L loan. The harassment was unbearable. The strategies here helped me understand the NPA timeline. I held my ground and eventually settled for 2.2 Lakhs after 7 months."
    },
    {
        "name": "Pooja M.",
        "location": "Bengaluru",
        "rating": 5,
        "text": "I was terrified of the legal notices for my 5 lakh default. Learning that I could negotiate the principal amount changed everything. I used the checklist to ensure I got a proper NOC from the bank."
    },
    {
        "name": "Rajesh K.",
        "location": "Delhi",
        "rating": 5,
        "text": "I was about to pay a scammer posing as a bank agent. This guide taught me to demand the official letterhead and verify the reference number. It saved me from making a terrible mistake."
    }
]

checklist_html = """
<div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 mb-8 mt-6">
    <h4 className="font-bold text-gray-900 mb-4 text-xl">Verification Checklist Before Paying</h4>
...
<div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 mb-8 mt-6">
    <h4 className="font-bold text-blue-900 mb-4 text-xl">Cost Breakdown: Typical ₹5 Lakh Settlement</h4>
    <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
            <thead>
                <tr className="border-b border-blue-200">
                    <th className="py-3 px-4 text-blue-900 font-semibold">Component</th>
                    <th className="py-3 px-4 text-blue-900 font-semibold text-right">Amount (₹)</th>
                </tr>
            </thead>
            <tbody className="text-gray-700">
                ...
                <tr className="border-b border-blue-200 font-semibold text-gray-900 bg-blue-100">
                ...
                <tr className="font-bold text-blue-900 text-lg">
...
<div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm mb-8 mt-6">
    <h4 className="font-bold text-gray-900 mb-4 text-xl">Case Study: Settling a ₹5 Lakh Loan After Job Loss</h4>
    <p className="text-gray-700 mb-4"><strong>Background:</strong> Ramesh, a marketing executive, took a ₹5,00,000 personal loan in 2023. After losing his job in 2024, he defaulted on payments. By month 6, his outstanding balance including penalties reached ₹5,80,000.</p>
    <p className="text-gray-700 mb-4"><strong>The Strategy:</strong> Ramesh communicated his job loss in writing but stopped taking aggressive recovery calls. He waited until the account aged past 180 days (deep NPA). When the bank offered a settlement at ₹4,00,000, he countered with ₹1,50,000, citing total illiquidity.</p>
    <p className="text-gray-700"><strong>The Result:</strong> After 4 weeks of back-and-forth negotiation, the bank agreed to a final settlement of ₹2,10,000 (42% of original principal). Ramesh liquidated a fixed deposit, paid directly into the loan account, and received his official NOC 15 days later, accepting the CIBIL impact in exchange for zero debt.</p>
</div>
"""
                    ...
                    <main className="lg:w-2/4 xl:w-3/5 w-full">
                        <article className="prose prose-lg max-w-none bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-gray-100">
                            ...
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {intro.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h2 id="is-settling-possible" className="text-3xl font-bold text-gray-900 mb-6 scroll-mt-14">Is Settling a 5 Lakh Personal Loan Possible?</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h2_1.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h2 id="anatomy-of-settlement" className="text-3xl font-bold text-gray-900 mb-6 scroll-mt-14">The Anatomy of a 5 Lakh Loan Settlement</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h2_2.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h3 id="calculating-components" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">Calculating the Principal vs Interest Component</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h3_2_1.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h3 id="bank-perspective" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">Understanding the Bank's Perspective on a 5 Lakh Default</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h3_2_2.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h2 id="step-by-step-process" className="text-3xl font-bold text-gray-900 mb-6 scroll-mt-14">Step-by-Step Process to Settle Your 5 Lakh Loan</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h2_3.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h3 id="step-1" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">Step 1: Assess Your True Financial Capacity</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h3_3_1.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h3 id="step-2" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">Step 2: Stop Payment and Wait for the Right Moment</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h3_3_2.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h3 id="step-3" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">Step 3: Initiate the Settlement Dialogue</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h3_3_3.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h3 id="step-4" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">Step 4: Negotiating the Settlement Amount (Target: 40-50%)</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                <span dangerouslySetInnerHTML={{{{__html: `{h3_3_4}`}}}} />
                            </p>
                            
                            <div dangerouslySetInnerHTML={{{{__html: `{cost_breakdown_html}`}}}} />

                            <h3 id="step-5" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">Step 5: Getting the Formal Settlement Letter</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h3_3_5.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>
                            
                            <div dangerouslySetInnerHTML={{{{__html: `{checklist_html}`}}}} />

                            <h2 id="risks-and-consequences" className="text-3xl font-bold text-gray-900 mb-6 scroll-mt-14">Risks and Consequences of Settling a 5 Lakh Loan</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h2_4.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h3 id="impact-on-cibil" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">The Immediate Impact on Your CIBIL Score</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                <span dangerouslySetInnerHTML={{{{__html: `{h3_4_1}`}}}} />
                            </p>

                            <h3 id="legal-action" className="text-2xl font-bold text-gray-800 mb-4 mt-8 scroll-mt-14">Potential Legal Action from Lenders</h3>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h3_4_2.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h2 id="when-to-seek-help" className="text-3xl font-bold text-gray-900 mb-6 scroll-mt-14">When to Seek Professional Help for a 5 Lakh Settlement</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h2_5.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>

                            <h2 id="alternatives" className="text-3xl font-bold text-gray-900 mb-6 scroll-mt-14">Alternatives to Settling Your 5 Lakh Loan</h2>
                            <p className="text-gray-700 leading-relaxed mb-6">
                                {h2_6.replace(chr(10), '</p><p className="text-gray-700 leading-relaxed mb-6">')}
                            </p>
                            ...
                            <div className="space-y-6">
                                {{faqs.map((faq, index) => (
                                    <div key={{index}} className="border-b border-gray-100 pb-4 last:border-0 hover:bg-gray-50 transition-colors p-2 rounded-lg">
                                        ...
                                        <p className="text-gray-600 leading-relaxed font-light" dangerouslySetInnerHTML={{{{__html: faq.a}}}}></p>
                                    </div>
                                ))}}
                            </div>

                            <h2 id="success-stories" className="text-3xl font-bold text-gray-900 mb-8 mt-12 scroll-mt-14">Client Success Stories</h2>
                            <div dangerouslySetInnerHTML={{{{__html: `{case_study_html}`}}}} />
                    ...
                    <aside className="lg:w-1/4 xl:w-1/5 w-full mt-8 lg:mt-0">
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm sticky top-14">
                            <div className="flex items-center space-x-4 mb-4">
                                <img src="/anujbhiya.png" alt="CredSettle Expert Author" className="w-16 h-16 rounded-full object-cover border-2 border-blue-100" />
                                <div>
                                    <h4 className="font-bold text-gray-900">CredSettle Expert</h4>
                                    <p className="text-sm text-gray-500">Legal & Financial Advisor</p>
                                </div>
                            </div>
...
with open(os.path.join(PAGE_DIR, "Settle5LakhClient.tsx"), "w") as f:
