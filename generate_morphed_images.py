...
PAGE_DIR = "/Users/amalegalsolutions/Desktop/AMAWORK/credsettlefigma/credsettle/src/app/recovery-agent-sending-morphed-images"
...
client_content = """import React, { useState, useEffect, useRef } from 'react';
...
with open(f"{PAGE_DIR}/page.tsx", "w") as f:
    f.write(clean_em_dashes(server_content))

with open(f"{PAGE_DIR}/MorphedImagesClient.tsx", "w") as f:
    f.write(clean_em_dashes(client_content))
