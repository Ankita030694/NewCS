                ...
                <div className="flex flex-col lg:flex-row gap-8 items-start justify-between">
                        ...
                        <article className="prose prose-lg max-w-none bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-gray-100">
                            ...
                            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 mb-6 font-light">
                                ...
                                <p className="text-gray-800">
                                    Recent data from financial regulatory bodies indicates that the unsecured credit sector, particularly credit cards, has seen unprecedented growth. Alongside this growth, the non performing asset (NPA) ratio for credit cards has climbed sharply. This 34% surge in defaults has created a massive secondary market for debt collection agencies and, unfortunately, fraudulent settlement consultants. Understanding these market dynamics is crucial because it explains why banks are currently more willing to negotiate, yet simultaneously more aggressive in their initial recovery tactics.
                                </p>
                            </div>
                            ...
                            <p className="text-gray-700 leading-relaxed mb-6">
                                Banks do not entertain settlement requests the moment you miss a single payment. During the first 90 days of delinquency, the bank's primary goal is full recovery. They will deploy their internal collections team to remind you, persuade you, and eventually pressure you into paying the minimum due. It is only after the account crosses the 90 day mark and is officially classified as a Non Performing Asset (NPA) that the window for settlement begins to open. Even then, the bank will first attempt to recover the full amount using third party collection agencies.
                            </p>
                    ...
                    <aside className="lg:w-1/5 w-full mt-8 lg:mt-0">
                        <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm sticky top-14 text-center">
                            ...
                            />
                            <h3 className="font-bold text-gray-900 text-lg">Anuj Bhiya</h3>
                            <p className="text-blue-600 text-sm font-semibold mb-4">Senior Legal Consultant</p>
                            <p className="text-gray-600 text-sm mb-6 leading-relaxed">
                                Anuj specializes in consumer debt protection and financial dispute resolution. With over 10 years of experience navigating the Indian banking sector, he helps borrowers secure legally binding settlements and defend against recovery harassment.
                            </p>
                            <Link 
                                href="/contact" 
...
# Double check for em-dashes and replace
content = content.replace("—", ",").replace("--", ",")

with open("/Users/amalegalsolutions/Desktop/AMAWORK/credsettlefigma/credsettle/src/app/credit-card-settlement/CreditCardSettlementClient.tsx", "w") as f:
    f.write(content)
