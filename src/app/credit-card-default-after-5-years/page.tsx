  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Can a bank sue for credit card default after 5 years?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Under the Limitation Act 1963, civil recovery is barred after 3 years from default. Without debt acknowledgment, suits filed after 5 years are dismissed under Section 3."
          }
        },
        {
          "@type": "Question",
          "name": "What is zombie debt in credit card collections?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Zombie debt is aged, time-barred debt written off by banks and sold to third-party collection agencies or ARCs, which attempt to revive expired claims."
          }
        },
        {
          "@type": "Question",
          "name": "Does making a token payment restart limitation?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Under Section 18 and Section 19 of the Limitation Act, partial payments or signed letters reset the 3-year clock, making expired debt legally enforceable again."
          }
        },
        {
          "@type": "Question",
          "name": "Can recovery agents arrest me for a 5-year-old default?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. Unsecured card default is purely a civil matter. Recovery agents have zero police powers, and the Supreme Court prohibits criminalizing civil loan defaults."
          }
        },
        {
          "@type": "Question",
          "name": "Can banks seize property for aged credit card debt?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. Credit cards are unsecured loans. Lenders cannot initiate SARFAESI property attachments without registered mortgage security and an enforceable court decree."
          }
        },
        {
          "@type": "Question",
          "name": "Why do banks sell 5-year-old defaults to ARCs?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Banks maintain 100% loss provisioning on aged NPAs and execute technical write-offs. They sell delinquent accounts to ARCs at 2% to 6% value to recover capital."
          }
        },
        {
          "@type": "Question",
          "name": "Will a 5-year-old default disappear from CIBIL?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. The Limitation Act bars civil litigation but does not erase credit records. The account remains Written-Off until resolved through an OTS and official NDC."
          }
        },
        {
          "@type": "Question",
          "name": "How much waiver can I get on a 5-year-old card default?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Because aged debts are time-barred and 100% provisioned, banks and ARCs accept settlements at 75% to 90% discounts, resolving debts for a fraction of principal."
          }
        },
        {
          "@type": "Question",
          "name": "What is the risk of ignoring legal notices for aged debt?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Ignoring notices risks lenders obtaining ex parte arbitration awards. Serving a formal statutory reply asserting the Limitation Act bar prevents fraudulent legal claims."
          }
        },
        {
          "@type": "Question",
          "name": "How does CredSettle resolve 5-year-old card defaults?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "CredSettle audits limitation dates, halts recovery harassment, serves statutory legal replies asserting the Limitation Act, and negotiates deep OTS closures with official NDCs."
          }
        }
      ]
    },
