          ...
          <div className="space-y-8 md:space-y-10 min-w-0">
            ...
            <section id="regulatory-citations" className="scroll-target space-y-4 pt-5 border-t border-slate-200">
              ...
              <ul className="space-y-1.5 text-xs text-slate-700 leading-relaxed list-disc pl-5">
                <li><a href="https://www.rbi.org.in" target="_blank" rel="noopener noreferrer" className="text-[#1886ff] hover:underline font-bold">RBI:</a> Master Direction on Fair Practices Code for Lenders.</li>
                <li><a href="https://cms.rbi.org.in" target="_blank" rel="noopener noreferrer" className="text-[#1886ff] hover:underline font-bold">RBI Ombudsman Scheme 2021:</a> Statutory dispute mechanism on cms.rbi.org.in.</li>
                <li><a href="https://www.indiacode.nic.in" target="_blank" rel="noopener noreferrer" className="text-[#1886ff] hover:underline font-bold">CICRA 2005 (§21):</a> Credit dispute resolution and bureau remark rectification.</li>
                <li><a href="https://www.indiacode.nic.in" target="_blank" rel="noopener noreferrer" className="text-[#1886ff] hover:underline font-bold">PSSA 2007 (§25):</a> Dishonour of electronic funds transfer / NACH mandates.</li>
                <li><a href="https://www.indiacode.nic.in" target="_blank" rel="noopener noreferrer" className="text-[#1886ff] hover:underline font-bold">RDB Act 1993 (§19):</a> Original Applications before Debt Recovery Tribunals (DRT).</li>
                <li><a href="https://www.indiacode.nic.in" target="_blank" rel="noopener noreferrer" className="text-[#1886ff] hover:underline font-bold">Indian Contract Act 1872:</a> Sections 73 &amp; 74 regarding contractual damages.</li>
                <li><a href="https://www.indiacode.nic.in" target="_blank" rel="noopener noreferrer" className="text-[#1886ff] hover:underline font-bold">NI Act 1881 (§138 &amp; §147):</a> Cheque dishonour defense and compounding of offenses.</li>
              </ul>
