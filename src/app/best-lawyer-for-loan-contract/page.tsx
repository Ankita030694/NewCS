...
export const metadata: Metadata = {
    ...
    description: 'Looking for the best lawyer for loan contract review or drafting in India? Get expert legal advice on loan agreements, Section 138, and borrower rights.',
