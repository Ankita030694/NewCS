                        ...
                        <article className="prose prose-lg max-w-none bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-gray-100">
                            ...
                            <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm mb-8">
                                ...
                                <ol className="list-decimal list-inside space-y-4 text-gray-700">
                                    ...
                                    <li className="pl-2">
                                        <span className="font-semibold text-blue-800">Involve Legal Counsel:</span> If the bank refuses to accept the application and threatens NPA status, a formal notice from an <Link href="/best-lawyer-for-education-loan-settlement" className="text-blue-600 hover:underline">education loan lawyer in India</Link> can force the bank to formally review the restructuring request under RBI guidelines.
                                    </li>
                                </ol>
                            </div>
