...
export const metadata: Metadata = {
    ...
    description: "Received a legal notice for a bank loan? Learn what to do when a bank sends a legal notice and if a bank can file a case for a personal loan in India.",
    keywords: [
