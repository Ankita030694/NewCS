...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.credsettle.com/services/credit-card-settlement/rajasthan'
  },
  robots: {
    index: true,
    follow: true,
...
const organizationSchema = {
  ...
  '@id': 'https://www.credsettle.com/services/credit-card-settlement/rajasthan',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: 'Rajasthan',
      item: 'https://www.credsettle.com/services/credit-card-settlement/rajasthan'
    }
  ]
};
...
const localBusinessSchema = {
  ...
  '@id': 'https://www.credsettle.com/services/credit-card-settlement/rajasthan',
  url: 'https://www.credsettle.com/services/credit-card-settlement/rajasthan',
  telephone: '+91-XXXXXXXXXX',
