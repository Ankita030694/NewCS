          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between" style={{ gap: '24px' }}>
            ...
            <div className="flex-1 flex items-center justify-center w-full lg:w-auto order-1 lg:order-2" style={{ minWidth: '0', position: 'relative' }}>
              <img
                ...
                alt={`${content.bankName} Credit Card Settlement in ${content.stateName}`}
            ...
            <div className="flex-1 w-full lg:w-auto" style={{ minWidth: '0', minHeight: '100vh' }}>
              {content.whyChooseSettlement && (
                <section id="why-choose-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    ...
                    style={{ color: '#0C2756', fontFamily: 'Poppins', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}
                  >
                    Why People Choose Credit Card Settlement with {content.bankName} in {content.stateName}
                  </h2>
              ...
              {content.understandingSettlement && (
                <section id="understanding-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 style={{ color: '#0C2756', fontFamily: 'Poppins', fontSize: '32px', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Understanding {content.bankName} Credit Card Settlement Process in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.localContext && (
                <section id="local-context" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h3 style={{ color: '#0C2756', fontFamily: 'Poppins', fontSize: '24px', fontWeight: 600, lineHeight: '32px', marginBottom: '16px' }}>
                    {content.bankName} Credit Card Settlement in {content.stateName} - Local Context
                  </h3>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.howCredSettleHelps && (
                <section id="how-credsettle-helps" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 style={{ color: '#0C2756', fontFamily: 'Poppins', fontSize: '32px', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    How CredSettle Helps You Settle {content.bankName} Credit Card Dues Legally in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.whyChooseCredSettle && (
                <section id="why-choose-credsettle" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 style={{ color: '#0C2756', fontFamily: 'Poppins', fontSize: '32px', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Why Choose CredSettle for {content.bankName} Credit Card Settlement in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.stepByStepProcess && (
                <section id="step-by-step-process" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 style={{ color: '#0C2756', fontFamily: 'Poppins', fontSize: '32px', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Step-by-Step Process to Start Your {content.bankName} Credit Card Settlement in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.documentsRequired && (
                <section id="documents-required" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 style={{ color: '#0C2756', fontFamily: 'Poppins', fontSize: '32px', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Documents Required for {content.bankName} Credit Card Settlement in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
            ...
            <div className="w-full max-w-7xl mx-auto px-4">
              <div className="flex flex-col items-center gap-8 md:gap-14">
                <div className="w-full">
                  <FAQWithSchema 
                    faqs={content.faqs} 
                    title={`${content.bankName} Credit Card Settlement in ${content.stateName}`}
                  />
                </div>
                  ...
                  <div className="flex flex-col items-center gap-[35px] w-full max-w-[644px]">
                    <div className="flex flex-col items-center gap-[28px] w-full">
                      <h2
                        ...
                        style={{ color: '#0C2756' }}
                      >
                        Ready to Settle Your {content.bankName} Credit Card Dues Legally in {content.stateName}?
                      </h2>
                      <p
