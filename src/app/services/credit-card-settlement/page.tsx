...
export default function CreditCardSettlementPage() {
  ...
  return (
    <div className="relative min-h-screen bg-white mt-6">
      {!isFirefox && (
        <div className="absolute top-0 left-0" style={{ width: '757px', height: '757px', borderRadius: '757px', background: '#007AFF', filter: 'blur(400px)', WebkitFilter: 'blur(400px)', transform: 'translate(-50%, -50%)', zIndex: 0, opacity: 0.3, willChange: 'filter', backfaceVisibility: 'hidden' }} />
      )}
      {isFirefox && (
      ...
      <div className="relative z-10" style={{ paddingTop: '84px' }}>
        ...
        <section
          ...
          style={{ maxWidth: '1280px', marginTop: '28px' }}
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-4 relative z-10">
                {['15,000+','4.9/5','₹ 850 Cr+','100%'].map((stat, idx) => (
