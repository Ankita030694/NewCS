          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between" style={{ gap: '24px' }}>
            ...
            <div className="flex-1 flex items-center justify-center w-full lg:w-auto order-1 lg:order-2" style={{ minWidth: '0', position: 'relative' }}>
              <img
                ...
                alt={`Credit Card Settlement in ${content.stateName}`}
        ...
        >
          ...
          >
            ...
            <div className="w-full" style={{ minWidth: '0', minHeight: '100vh' }}>
              {/* H2: Why Credit Card Settlement Is Essential */}
              {content.whyCreditCardSettlement && (
                <section id="why-credit-card-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>{content.whyCreditCardSettlement}</p>
                  </div>
                </section>
              )}

              {/* H2: Common Credit Card Problems */}
              {content.commonCreditCardProblems && (
                <section id="common-credit-card-problems" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    className="text-xl md:text-2xl lg:text-[32px] leading-tight"
                    style={{
                      color: '#0C2756',
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>{content.commonCreditCardProblems}</p>
                  </div>
                </section>
              )}

              {/* H2: CredSettle Overview */}
              ...
              {/* H2: Benefits */}
              {content.benefits && (
                <section id="settlement-benefits" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    className="text-xl md:text-2xl lg:text-[32px] leading-tight"
                    style={{
                      color: '#0C2756',
        ...
        <section className="w-full py-12" id="faqs" style={{ scrollMarginTop: '100px' }}>
          <div className="w-full max-w-7xl mx-auto px-4">
            <div className="flex flex-col items-center gap-8 md:gap-14">
              ...
              <FAQWithSchema
                faqs={content.faqs}
                title={`Credit Card Settlement in ${content.stateName}`}
              />
              ...
              >
                <div className="flex flex-col items-center gap-[35px] w-full max-w-[644px]">
                  <div className="flex flex-col items-center gap-[28px] w-full">
                    ...
                    >
                      Secure an RBI-compliant settlement and end compounding interest—start today.
                    </p>
                  </div>
