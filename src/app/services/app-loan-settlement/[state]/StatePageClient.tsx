        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between" style={{ gap: '24px' }}>
            ...
            <div className="flex-1 w-full lg:w-auto order-2 lg:order-1" style={{ maxWidth: '640px' }}>
              ...
              >
                {content.heroTitle || `App Loan Settlement in ${content.stateName} - Stop Harassment, Settle Legally with CredSettle`}
              </h1>
              <p
        ...
        >
          ...
          >
            ...
            <div className="flex-1 w-full lg:w-auto" style={{ minWidth: '0', minHeight: '100vh' }}>
              {/* H2: Why App Loan Settlement Is Essential */}
              {content.whyAppLoanSettlement && (
                <section id="why-app-loan-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>{content.whyAppLoanSettlement}</p>
                  </div>
                </section>
              )}

              {/* H2: Common App Loan Problems */}
              {content.commonAppLoanProblems && (
                <section id="common-app-loan-problems" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    className="text-xl md:text-2xl lg:text-[32px] leading-tight"
                    style={{
                      color: '#0C2756',
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>{content.commonAppLoanProblems}</p>
                  </div>
                </section>
              )}

              {/* H2: CredSettle - India's Trusted App Loan Crisis Intervention Service */}
              {content.credsettleOverview && (
                <section id="credsettle-overview" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    CredSettle - India&apos;s Trusted App Loan Crisis Intervention Service
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
                  ...
                  >
                    ...
                    {/* H3: Our RBI-Compliant App Loan Settlement Process */}
                    {content.rbiCompliantProcess && (
                      <div id="rbi-compliant-process" style={{ marginTop: '32px', scrollMarginTop: '100px' }}>
                        ...
                        >
                          Our RBI-Compliant App Loan Settlement Process
                        </h3>
                        <p style={{ marginBottom: '16px' }}>{content.rbiCompliantProcess}</p>
                      </div>
                    )}

                    {/* H3: How CredSettle Helps You Negotiate with App Lenders */}
                    {content.negotiationHelp && (
                      <div id="negotiation-help" style={{ marginTop: '32px', scrollMarginTop: '100px' }}>
                        ...
                        >
                          How CredSettle Helps You Negotiate with App Lenders
                        </h3>
              ...
              {/* H2: Legal Protection and Harassment Cessation */}
              {content.legalSupport && (
                <section id="legal-support" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Legal Protection and Harassment Cessation
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
              ...
              {/* H2: RBI Guidelines & Your Legal Rights */}
              ...
              {/* H2: Step-by-Step Settlement Guide */}
        ...
        <section className="w-full py-12" id="faqs" style={{ scrollMarginTop: '100px' }}>
          <div className="w-full max-w-7xl mx-auto px-4">
            <div className="flex flex-col items-center gap-8 md:gap-14">
              ...
              <FAQWithSchema
                faqs={content.faqs}
                title={`App Loan Settlement in ${content.stateName}`}
              />
                ...
                <div className="flex flex-col items-center gap-[35px] w-full max-w-[644px]">
                  <div className="flex flex-col items-center gap-[28px] w-full">
                    <h2
                      ...
                      style={{ color: '#0C2756' }}
                    >
                      Ready to Stop App Loan Harassment?
                    </h2>
                    <p
                      className="text-center text-[14px] md:text-[18px] leading-[14px] md:leading-[18px] font-normal w-full"
                      style={{ color: 'rgba(12, 39, 86, 0.70)' }}
                    >
                      Stop harassment in 48 hours, protect your privacy, and secure RBI-compliant settlement today.
                    </p>
                  </div>
