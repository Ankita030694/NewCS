...
function generateHeadings(content: any) {
  ...
  if (content.credsettleOverview) {
    ...
    if (content.rbiCompliantProcess) {
      headings.push({
        ...
        text: 'Our RBI-Compliant App Loan Settlement Process',
        level: 3
      });
    }
    ...
    if (content.negotiationHelp) {
      headings.push({
        id: 'negotiation-help',
        text: 'How CredSettle Helps You Negotiate with App Lenders',
        level: 3
      });
    }
  }
  ...
  if (content.legalSupport) {
    headings.push({
      id: 'legal-support',
      text: 'Legal Protection and Harassment Cessation',
      level: 2
    });
  }
