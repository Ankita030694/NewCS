...
export function generateBankContent(bankSlug: string): Partial<BankContent> | {} {
  ...
  return {
    ...
    cibilImpact: [
      ...
      `Importantly, settling with ${name} through CredSettle means you receive proper documentation—closure letters, NOCs, settlement certificates—that future lenders can review to understand your settlement was a structured, legal resolution rather than a default. This documentation helps during credit rebuilding, as lenders see you took responsible action to resolve debt through proper app loan settlement channels, rather than abandoning obligations.`
    ][impactVariant],
