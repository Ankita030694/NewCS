            ...
            <div className="flex flex-col items-center gap-8 md:gap-14">
              <div className="flex flex-col lg:flex-row items-start gap-6 lg:gap-[76px] w-full">
                <div className="flex flex-col items-start gap-[21px] w-full lg:w-[365px]">
                  <h2 className="text-[24px] md:text-[32px] leading-[24px] md:leading-[32px] font-bold"><span style={{ color: '#0C2756' }}>App Loan Settlement{`\n`}<br /> FAQs — </span><span style={{ color: '#007AFF' }}>Answered.</span></h2>
                ...
                <div className="w-full lg:w-[800px] lg:ml-auto p-4 rounded-xl" style={{ background: '#EFF7FF' }}>
                  <div className="flex flex-col gap-4">
                    {[
                      { q: 'How quickly can you stop app loan harassment?', a: 'Immediately. We assume communications and file complaints against illegal practices.' },
                      { q: 'Is a legal OTS possible with app lenders?', a: 'Yes, we secure documented settlements where policy allows and ensure proper closure.' },
                      { q: 'Will my contacts be safe?', a: 'We push back on unlawful data use and prioritize your privacy and dignity.' }
                    ].map((item, i) => (
