...
import { BankStateContent } from '../bank-state-content-generator';

interface StatePageClientProps {
  content: BankStateContent;
        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between" style={{ gap: '24px' }}>
            ...
            <div className="flex-1 flex items-center justify-center w-full lg:w-auto order-1 lg:order-2" style={{ minWidth: '0', position: 'relative' }}>
              <img
                src="/app_hero.png"
                alt={`${content.bankName} App Loan Settlement in ${content.stateName}`}
            ...
            <div className="flex-1 w-full lg:w-auto" style={{ minWidth: '0', minHeight: '100vh' }}>
              {content.whyChooseSettlement && (
                <section id="why-choose-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 className="text-xl md:text-2xl lg:text-[32px] leading-tight" style={{ color: '#0C2756', fontFamily: 'Poppins', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Why People Choose App Loan Settlement with {content.bankName} in {content.stateName}
                  </h2>
              ...
              {content.understandingSettlement && (
                <section id="understanding-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 className="text-xl md:text-2xl lg:text-[32px] leading-tight" style={{ color: '#0C2756', fontFamily: 'Poppins', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Understanding {content.bankName} App Loan Settlement Process in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.localContext && (
                <section id="local-context" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h3 style={{ color: '#0C2756', fontFamily: 'Poppins', fontSize: '24px', fontWeight: 600, lineHeight: '32px', marginBottom: '16px' }}>
                    {content.bankName} App Loan Settlement in {content.stateName} - Local Context
                  </h3>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
                    <p style={{ marginBottom: '16px' }}>{content.localContext}</p>
                  </div>
                </section>
              )}
              ...
              {content.howCredSettleHelps && (
                <section id="how-credsettle-helps" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 className="text-xl md:text-2xl lg:text-[32px] leading-tight" style={{ color: '#0C2756', fontFamily: 'Poppins', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    How CredSettle Helps You Settle {content.bankName} App Loan Dues Legally in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.whyChooseCredSettle && (
                <section id="why-choose-credsettle" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 className="text-xl md:text-2xl lg:text-[32px] leading-tight" style={{ color: '#0C2756', fontFamily: 'Poppins', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Why Choose CredSettle for {content.bankName} App Loan Settlement in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.stepByStepProcess && (
                <section id="step-by-step-process" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 className="text-xl md:text-2xl lg:text-[32px] leading-tight" style={{ color: '#0C2756', fontFamily: 'Poppins', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Step-by-Step Process to Start Your {content.bankName} App Loan Settlement in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
              ...
              {content.documentsRequired && (
                <section id="documents-required" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2 className="text-xl md:text-2xl lg:text-[32px] leading-tight" style={{ color: '#0C2756', fontFamily: 'Poppins', fontWeight: 700, lineHeight: '36px', marginBottom: '20px' }}>
                    Documents Required for {content.bankName} App Loan Settlement in {content.stateName}
                  </h2>
                  <div className="text-sm md:text-base lg:text-[16px] leading-relaxed" style={{ color: 'rgba(12, 39, 86, 0.80)', fontFamily: 'Poppins', lineHeight: '28px' }}>
            ...
            <div className="w-full max-w-7xl mx-auto px-4">
              <div className="flex flex-col items-center gap-8 md:gap-14">
                <div className="w-full">
                  <FAQWithSchema faqs={content.faqs} title={`${content.bankName} App Loan Settlement in ${content.stateName}`} />
                </div>
                <div
                  id="get-legal-help"
                  className="flex justify-center items-center w-full rounded-xl px-3 py-8 md:py-[63px]"
                  style={{ background: 'linear-gradient(180deg, rgba(191, 238, 255, 0.50) 27.61%, #007AFF 100%)', boxShadow: '0 5px 16px 0 rgba(0, 0, 0, 0.15)', scrollMarginTop: '100px' }}
                >
                  <div className="flex flex-col items-center gap-[35px] w-full max-w-[644px]">
                    <div className="flex flex-col items-center gap-[28px] w-full">
                      <h2 className="text-center text-[21px] md:text-[28px] leading-[21px] md:leading-[28px] font-normal w-full" style={{ color: '#0C2756' }}>
                        Ready to Settle Your {content.bankName} App Loan Dues Legally in {content.stateName}?
                      </h2>
                      <p className="text-center text-[14px] md:text-[18px] leading-[14px] md:leading-[18px] font-normal w-full" style={{ color: 'rgba(12, 39, 86, 0.70)' }}>
                        Get professional legal assistance from CredSettle's lawyer panel. Navigate {content.bankName} issuer policies, secure an RBI-compliant One-Time Settlement, and end harassment—start your path to freedom today.
                      </p>
                    </div>
                    <button className="px-[28px] py-[14px] rounded-xl bg-white transition-opacity duration-200 hover:opacity-90 cursor-pointer" style={{ boxShadow: '0 -3px 7px 0 rgba(9, 9, 9, 0.30) inset, 0 3px 7px 0 rgba(9, 9, 9, 0.30) inset' }} onClick={() => window.location.href = '/contact'}>
                      <span className="text-[13px] md:text-[14px] leading-[13px] md:leading-[14px] font-normal" style={{ color: '#0C2756' }}>Talk to a Legal Expert Today</span>
                    </button>
                  </div>
                </div>
              </div>
