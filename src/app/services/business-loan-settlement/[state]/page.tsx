...
export async function generateMetadata({ 
  ...
  return {
    alternates: { canonical: `https://www.credsettle.com/services/business-loan-settlement/${resolvedParams.state}` },
...
function generateHeadings(content: any) {
  ...
  if (content.credsettleOverview) {
    headings.push({
      ...
      text: 'CredSettle - India’s Trusted Business Loan Settlement Company',
      level: 2
    });
    ...
    if (content.rbiCompliantProcess) {
      headings.push({
        ...
        text: 'Our RBI-Compliant Business Loan Settlement Process',
        level: 3
      });
    }
    ...
    if (content.negotiationHelp) {
      headings.push({
        id: 'negotiation-help',
        text: 'How CredSettle Helps You Negotiate with Banks & NBFCs',
        level: 3
      });
    }
  }
