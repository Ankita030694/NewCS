...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.credsettle.com/services/personal-loan-settlement/karnataka'
  },
  robots: {
    index: true,
    follow: true,
...
const organizationSchema = {
  ...
  '@id': 'https://www.credsettle.com/services/personal-loan-settlement/karnataka',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: 'Karnataka',
      item: 'https://www.credsettle.com/services/personal-loan-settlement/karnataka'
    }
  ]
};
...
const localBusinessSchema = {
  ...
  '@id': 'https://www.credsettle.com/services/personal-loan-settlement/karnataka',
  url: 'https://www.credsettle.com/services/personal-loan-settlement/karnataka',
  telephone: '+91-XXXXXXXXXX',
