        ...
        >
          ...
          >
            ...
            <div className="w-full" style={{ minWidth: '0', minHeight: '100vh' }}>
              {/* Check if using new comprehensive format or old format */}
              {content.whyLoanSettlement ? (
                <>
                  {/* State-Specific Introduction */}
                  {content.stateIntroduction && (
                    <section style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                      <div
                      ...
                      >
                        <p style={{ marginBottom: '16px' }}>{content.stateIntroduction}</p>
                      </div>
                    </section>
                  )}

                  {/* H2: Why Loan Settlement Is a Smart Financial Step */}
                  {content.whyLoanSettlement && (
                    <section id="why-loan-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                  ...
                  >
                        <p style={{ marginBottom: '16px' }}>{content.whyLoanSettlement}</p>
                      </div>
                    </section>
                  )}

                  {/* H2: Common Loan Problems Faced in [STATE] */}
                  {content.commonLoanProblems && (
                    <section id="common-loan-problems" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    className="text-xl md:text-2xl lg:text-[32px] leading-tight"
                    style={{
                      color: '#0C2756',
                  ...
                  >
                        <p style={{ marginBottom: '16px' }}>{content.commonLoanProblems}</p>
                      </div>
                    </section>
                  )}
                  ...
                  {/* H2: Types of Loans We Help Settle in [STATE] */}
                  {content.typesOfLoans && (
                    <section id="types-of-loans" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    className="text-xl md:text-2xl lg:text-[32px] leading-tight"
                    style={{
                      color: '#0C2756',
                  ...
                  >
                        <div style={{ marginBottom: '32px' }}>
                          ...
                          <p style={{ marginBottom: '16px' }}>{content.typesOfLoans.creditCard}</p>
                        </div>
                        <div style={{ marginBottom: '32px' }}>
                          <h3
                            style={{
                          ...
                          <p style={{ marginBottom: '16px' }}>{content.typesOfLoans.personalLoan}</p>
                        </div>
                        <div style={{ marginBottom: '32px' }}>
                          <h3
                            style={{
                          ...
                          <p style={{ marginBottom: '16px' }}>{content.typesOfLoans.businessLoan}</p>
                        </div>
                        <div style={{ marginBottom: '32px' }}>
                          <h3
                            style={{
                          ...
                          <p style={{ marginBottom: '16px' }}>{content.typesOfLoans.autoLoan}</p>
                        </div>
                      </div>
                    </section>
                  )}
                  ...
                  {/* H2: RBI Guidelines & Legal Rights of Borrowers */}
                ...
                <>
                  ...
                  >
                        <p style={{ marginBottom: '16px' }}>{content.introduction}</p>
                      </div>
                    </section>
                  )}
                  ...
                  >
                        <p style={{ marginBottom: '16px' }}>{content.overview}</p>
                      </div>
                    </section>
                  )}
                  ...
                  >
                        <p style={{ marginBottom: '16px' }}>{content.process}</p>
                      </div>
                    </section>
                  )}

                  {content.legalAspects && (
                    <section id="legal-aspects" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    className="text-xl md:text-2xl lg:text-[32px] leading-tight"
                    style={{
                      color: '#0C2756',
                  ...
                  >
                        <p style={{ marginBottom: '16px' }}>{content.legalAspects}</p>
                      </div>
                    </section>
                  )}
                </>
        ...
        <section className="w-full py-12" id="faqs" style={{ scrollMarginTop: '100px' }}>
          <div className="w-full max-w-7xl mx-auto px-4">
            <div className="flex flex-col items-center gap-8 md:gap-14">
              ...
              <FAQWithSchema
                faqs={content.faqs}
                title={`Personal Loan Settlement in ${content.stateName}`}
              />
