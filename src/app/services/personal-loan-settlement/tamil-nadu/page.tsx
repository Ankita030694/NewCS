...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.credsettle.com/services/personal-loan-settlement/tamil-nadu'
  },
  robots: {
    index: true,
    follow: true,
...
const organizationSchema = {
  ...
  '@id': 'https://www.credsettle.com/services/personal-loan-settlement/tamil-nadu',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: 'Tamil Nadu',
      item: 'https://www.credsettle.com/services/personal-loan-settlement/tamil-nadu'
    }
  ]
};
...
const localBusinessSchema = {
  ...
  '@id': 'https://www.credsettle.com/services/personal-loan-settlement/tamil-nadu',
  url: 'https://www.credsettle.com/services/personal-loan-settlement/tamil-nadu',
  telephone: '+91-XXXXXXXXXX',
