...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.credsettle.com/services/personal-loan-settlement/rajasthan'
  },
  robots: {
    index: true,
    follow: true,
...
const organizationSchema = {
  ...
  '@id': 'https://www.credsettle.com/services/personal-loan-settlement/rajasthan',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: 'Rajasthan',
      item: 'https://www.credsettle.com/services/personal-loan-settlement/rajasthan'
    }
  ]
};
...
const localBusinessSchema = {
  ...
  '@id': 'https://www.credsettle.com/services/personal-loan-settlement/rajasthan',
  url: 'https://www.credsettle.com/services/personal-loan-settlement/rajasthan',
  telephone: '+91-XXXXXXXXXX',
