...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: content.metaDescription,
      type: 'article',
      url: `https://credsettle.com/services/personal-loan-settlement/banks/${content.bankSlug}/${content.stateSlug}`
    },
    twitter: {
    ...
    alternates: {
      canonical: `https://credsettle.com/services/personal-loan-settlement/banks/${content.bankSlug}/${content.stateSlug}`
    }
  };
}
...
function generateHeadings(content: any) {
  ...
  if (content.whyChooseSettlement) {
    headings.push({
      ...
      text: `Why People Choose Loan Settlement with ${content.bankName} in ${content.stateName}`,
      level: 2
    });
  }
  ...
  if (content.understandingSettlement) {
    headings.push({
      ...
      text: `Understanding ${content.bankName} Loan Settlement Process in ${content.stateName}`,
      level: 2
    });
  }
  ...
  if (content.localContext) {
    headings.push({
      id: 'local-context',
      text: `${content.bankName} Personal Loan Settlement in ${content.stateName} - Local Context`,
      level: 3
    });
  }
  ...
  if (content.howCredSettleHelps) {
    headings.push({
      ...
      text: `How CredSettle Helps You Settle ${content.bankName} Loans Legally in ${content.stateName}`,
      level: 2
    });
  }
  ...
  if (content.cibilImpact) {
    headings.push({
      id: 'cibil-impact',
      text: 'Impact of Loan Settlement on Your CIBIL Score',
      level: 2
    });
  }
  ...
  if (content.whyChooseCredSettle) {
    headings.push({
      ...
      text: `Why Choose CredSettle for ${content.bankName} Loan Settlement in ${content.stateName}`,
      level: 2
    });
  }
  ...
  if (content.stepByStepProcess) {
    headings.push({
      ...
      text: `Step-by-Step Process to Start Your ${content.bankName} Loan Settlement in ${content.stateName}`,
      level: 2
    });
  }
  ...
  if (content.documentsRequired) {
    headings.push({
      ...
      text: `Documents Required for ${content.bankName} Loan Settlement in ${content.stateName}`,
      level: 2
    });
  }
  ...
  headings.push({
    id: 'faqs',
    text: `FAQs on ${content.bankName} Personal Loan Settlement in ${content.stateName}`,
    level: 2
  });
...
export default async function StatePage({ params }: PageProps) {
  ...
  const structuredData = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://credsettle.com/services/personal-loan-settlement/banks/${content.bankSlug}/${content.stateSlug}`
    },
    about: {
      '@type': 'FinancialService',
      name: `${content.bankName} Personal Loan Settlement in ${content.stateName}`,
      provider: {
        '@type': 'Organization',
        name: 'CredSettle',
        url: 'https://credsettle.com'
