...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.credsettle.com/services/credit-score-builder' },
  title: 'Complete Guide to CIBIL Credit Score Builder',
  description: 'Comprehensive guide to CIBIL credit score building in India. Learn about credit score improvement, credit report analysis.',
