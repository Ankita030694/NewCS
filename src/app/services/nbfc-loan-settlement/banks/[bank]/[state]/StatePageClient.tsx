        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between" style={{ gap: '24px' }}>
            ...
            <div className="flex-1 flex items-center justify-center w-full lg:w-auto order-1 lg:order-2" style={{ minWidth: '0', position: 'relative' }}>
              <img
                src="/nbfc_hero.png"
                alt={`${content.bankName} NBFC Loan Settlement in ${content.stateName}`}
        ...
        >
          ...
          >
            ...
            <div className="flex-1 w-full lg:w-auto" style={{ minWidth: '0', minHeight: '100vh' }}>
              {/* H2: Why People Choose NBFC Loan Settlement with [Bank Name] in [State] */}
              {content.whyChooseSettlement && (
                <section id="why-choose-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Why People Choose NBFC Loan Settlement with {content.bankName} in {content.stateName}
                  </h2>
                  <div
              ...
              {/* H2: Understanding [Bank Name] NBFC Loan Settlement Process in [State] */}
              {content.understandingSettlement && (
                <section id="understanding-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Understanding {content.bankName} NBFC Loan Settlement Process in {content.stateName}
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
              ...
              {content.localContext && (
                <section id="local-context" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                        ...
                        >
                    {content.bankName} NBFC Loan Settlement in {content.stateName} - Local Context
                  </h3>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
              ...
              {/* H2: How CredSettle Helps You Settle [Bank Name] NBFC Loan Dues Legally in [State] */}
              {content.howCredSettleHelps && (
                <section id="how-credsettle-helps" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    How CredSettle Helps You Settle {content.bankName} NBFC Loan Dues Legally in {content.stateName}
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
              ...
              {content.cibilImpact && (
                <section id="cibil-impact" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Impact of NBFC Loan Settlement on Your CIBIL Score
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
              ...
              {/* H2: Why Choose CredSettle for [Bank Name] NBFC Loan Settlement in [State] */}
              {content.whyChooseCredSettle && (
                <section id="why-choose-credsettle" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Why Choose CredSettle for {content.bankName} NBFC Loan Settlement in {content.stateName}
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
              ...
              {/* H2: Step-by-Step Process to Start Your [Bank Name] NBFC Loan Settlement in [State] */}
              {content.stepByStepProcess && (
                <section id="step-by-step-process" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Step-by-Step Process to Start Your {content.bankName} NBFC Loan Settlement in {content.stateName}
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
              ...
              {/* H2: Documents Required for [Bank Name] NBFC Loan Settlement in [State] */}
              {content.documentsRequired && (
                <section id="documents-required" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Documents Required for {content.bankName} NBFC Loan Settlement in {content.stateName}
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
            ...
            <div className="w-full max-w-7xl mx-auto px-4">
              <div className="flex flex-col items-center gap-8 md:gap-14">
                ...
                <div className="w-full">
                  <FAQWithSchema 
                    faqs={content.faqs} 
                    title={`${content.bankName} NBFC Loan Settlement in ${content.stateName}`}
                  />
                </div>
                  ...
                  <div className="flex flex-col items-center gap-[35px] w-full max-w-[644px]">
                    ...
                    <div className="flex flex-col items-center gap-[28px] w-full">
                      <h2
                        ...
                        style={{ color: '#0C2756' }}
                      >
                        Ready to Settle Your {content.bankName} NBFC Loan Dues Legally in {content.stateName}?
                      </h2>
                      <p
                        className="text-center text-[14px] md:text-[18px] leading-[14px] md:leading-[18px] font-normal w-full"
                        style={{ color: 'rgba(12, 39, 86, 0.70)' }}
                      >
                        Get professional legal assistance from CredSettle's lawyer panel. Navigate {content.bankName} NBFC policies, secure an RBI-compliant One-Time Settlement, and end harassment—start your path to freedom today.
                      </p>
                    </div>
