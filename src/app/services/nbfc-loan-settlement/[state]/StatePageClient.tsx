        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between" style={{ gap: '24px' }}>
            ...
            <div className="flex-1 w-full lg:w-auto order-2 lg:order-1" style={{ maxWidth: '640px' }}>
              ...
              >
                {content.heroTitle || `NBFC Loan Settlement in ${content.stateName} - Settle Legally, Reduce Debt with CredSettle`}
              </h1>
              <p
        ...
        >
          ...
          >
            ...
            <div className="flex-1 w-full lg:w-auto" style={{ minWidth: '0', minHeight: '100vh' }}>
              {/* H2: Why NBFC Loan Settlement */}
              {content.whyNBFCLoanSettlement && (
                <section id="why-nbfc-loan-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>{content.whyNBFCLoanSettlement}</p>
                  </div>
                </section>
              )}

              {/* H2: Common NBFC Loan Problems */}
              {content.commonNBFCLoanProblems && (
                <section id="common-nbfc-loan-problems" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    className="text-xl md:text-2xl lg:text-[32px] leading-tight"
                    style={{
                      color: '#0C2756',
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>{content.commonNBFCLoanProblems}</p>
                  </div>
                </section>
              )}
        ...
        <section className="w-full py-12" id="faqs" style={{ scrollMarginTop: '100px' }}>
          <div className="w-full max-w-7xl mx-auto px-4">
            <div className="flex flex-col items-center gap-8 md:gap-14">
              ...
              <FAQWithSchema
                faqs={content.faqs}
                title={`NBFC Loan Settlement in ${content.stateName}`}
              />
                ...
                <div className="flex flex-col items-center gap-[35px] w-full max-w-[644px]">
                  <div className="flex flex-col items-center gap-[28px] w-full">
                    <h2
                      ...
                      style={{ color: '#0C2756' }}
                    >
                      Ready to Settle Your NBFC Loan?
                    </h2>
                    <p
                      className="text-center text-[14px] md:text-[18px] leading-[14px] md:leading-[18px] font-normal w-full"
                      style={{ color: 'rgba(12, 39, 86, 0.70)' }}
                    >
                      Stop harassment, reduce debt by 40-70%, and secure your RBI-compliant settlement today.
                    </p>
                  </div>
