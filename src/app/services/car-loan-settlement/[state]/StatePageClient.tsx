        ...
        >
          ...
          >
            ...
            <div className="w-full" style={{ minWidth: '0', minHeight: '100vh' }}>
              {/* H2: Why Car Loan Settlement Is Essential */}
              {content.whyCarLoanSettlement && (
                <section id="why-car-loan-settlement" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>{content.whyCarLoanSettlement}</p>
                  </div>
                </section>
              )}

              {/* H2: Common Car Loan Problems */}
              {content.commonCarLoanProblems && (
                <section id="common-car-loan-problems" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  <h2
                    className="text-xl md:text-2xl lg:text-[32px] leading-tight"
                    style={{
                      color: '#0C2756',
                  ...
                  >
                    <p style={{ marginBottom: '16px' }}>{content.commonCarLoanProblems}</p>
                  </div>
                </section>
              )}
              ...
              {content.credsettleOverview && (
                <section id="credsettle-overview" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    CredSettle - India&apos;s Trusted Car Loan Settlement Company
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
                  ...
                  >
                    ...
                    {/* H3: Our RBI-Compliant Car Loan Settlement Process */}
                    {content.rbiCompliantProcess && (
                      <div id="rbi-compliant-process" style={{ marginTop: '32px', scrollMarginTop: '100px' }}>
                        ...
                        >
                          Our RBI-Compliant Car Loan Settlement Process
                        </h3>
                        <p style={{ marginBottom: '16px' }}>{content.rbiCompliantProcess}</p>
                      </div>
                    )}

                    {/* H3: How CredSettle Helps You Negotiate with Lenders */}
                    {content.negotiationHelp && (
                      <div id="negotiation-help" style={{ marginTop: '32px', scrollMarginTop: '100px' }}>
                        ...
                        >
                          How CredSettle Helps You Negotiate with Lenders
                        </h3>
              ...
              {/* H2: Legal Support and Vehicle Protection */}
              {content.legalSupport && (
                <section id="legal-support" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Legal Support and Vehicle Protection
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
              ...
              {/* H2: RBI Guidelines & Borrower Rights */}
              ...
              {content.stepByStepGuide && (
                <section id="step-by-step-guide" style={{ marginBottom: '48px', scrollMarginTop: '100px' }}>
                  ...
                  >
                    Step-by-Step Guide to Car Loan Settlement with CredSettle
                  </h2>
                  <div
                    className="text-sm md:text-base lg:text-[16px] leading-relaxed"
                    style={{
        ...
        <section className="w-full py-12" id="faqs" style={{ scrollMarginTop: '100px' }}>
          <div className="w-full max-w-7xl mx-auto px-4">
            <div className="flex flex-col items-center gap-8 md:gap-14">
              ...
              <FAQWithSchema
                faqs={content.faqs}
                title={`Car Loan Settlement in ${content.stateName}`}
              />
                ...
                <div className="flex flex-col items-center gap-[35px] w-full max-w-[644px]">
                  <div className="flex flex-col items-center gap-[28px] w-full">
                    <h2
                      ...
                      style={{ color: '#0C2756' }}
                    >
                      Ready to Settle Your Car Loan?
                    </h2>
                    <p
                      className="text-center text-[14px] md:text-[18px] leading-[14px] md:leading-[18px] font-normal w-full"
                      style={{ color: 'rgba(12, 39, 86, 0.70)' }}
                    >
                      Stop harassment, prevent repossession, and secure your RBI-compliant settlement today.
                    </p>
                  </div>
