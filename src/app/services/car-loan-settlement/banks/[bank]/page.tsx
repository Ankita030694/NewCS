...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: content.metaDescription,
      type: 'article',
      url: `https://credsettle.com/services/car-loan-settlement/banks/${content.slug}`
    },
    twitter: {
    ...
    alternates: {
      canonical: `https://credsettle.com/services/car-loan-settlement/banks/${content.slug}`
    }
  };
}
...
export default async function BankPage({ params }: PageProps) {
  ...
  const structuredData = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://credsettle.com/services/car-loan-settlement/banks/${content.slug}`
    },
    about: {
