...
export const metadata: Metadata = {
    ...
    description: "Facing builder loan recovery issues? Get specialized legal defence for project finance matters, SARFAESI Act, DRT proceedings, and RERA compliance.",
    keywords: [
