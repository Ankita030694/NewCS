...
export const metadata: Metadata = {
  ...
  description: "Learn about CredSettle - India’s leading legal loan settlement company. We specialize in RBI-compliant debt resolution and borrower harassment protection.",
  keywords: [
    "about CredSettle",
