    ...
    <div className="relative min-h-screen overflow-x-hidden bg-cover md:bg-contain bg-center" style={{paddingTop: '16.2px', backgroundImage: 'url(/hero-bg.png)'}}>
      ...
      >
          <nav className="w-full bg-transparent">
            <div className="py-3 md:py-[12.96px] md:px-[70px] px-5">
    ...
    <div className="absolute inset-0 flex items-center justify-center px-4 md:px-[16.2px]" style={{ transform: 'translateY(-4.5%)', zIndex: 1, pointerEvents: 'none' }}>
      <div className="flex flex-col items-center gap-4 md:gap-[32.4px]" style={{pointerEvents: 'auto' }}>
        ...
        >
          ...
          <p className="text-white font-medium text-center text-2xl opacity-90" style={{ fontWeight: 400, lineHeight: '1.6' }}>
            <span 
              className="inline-block rounded-[32.4px] px-2 py-[0.1px] md:px-[13.2px] md:py-[0.48px]"
              style={{ 
                color: 'rgb(226, 48, 28)',
              }}
            >Loan Recovery calls? </span>

            Get peace of mind with CredSettle.
          </p>
        </div>
        <a
          href="/contact"
          ...
          style={{
            ...
            paddingLeft: "2.5rem", // 30% larger than 2.25rem (9 * 1.3 = 11.7px * 1.3 = 15.21px; but since px-9 ~2.25rem, 2.25*1.3 ≈ 2.925rem)
            paddingRight: "2.5rem",
            paddingTop: "1rem", // 30% larger than 0.75rem
            paddingBottom: "1rem",
