        ...
        <div className="bg-white rounded-[15px] md:rounded-[30px] border border-[rgba(12,39,86,0.20)] shadow-[0_0_23.5px_0_rgba(0,0,0,0.10)] p-6 md:p-10 lg:p-[40px]">
          ...
          <div className="flex flex-col gap-4 md:gap-5 mb-8 border-t border-[rgba(12,39,86,0.10)] pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-2">
              ...
              <a href="/sue-bank-recovery-agent-for-defamation-india" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Sue Bank for Defamation...</a>
              <a href="/legal-notice-to-loan-guarantor-liability" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Loan Guarantor Legal Notice...</a>
              <a href="/personal-loan-time-barred-after-3-years-limitation-act" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Time-Barred Loan Limitation Act...</a>
              <a href="/voluntary-surrender-vehicle-car-loan-shortfall" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Voluntary Car Surrender Shortfall...</a>
