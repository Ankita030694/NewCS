        ...
        <div className="bg-white rounded-[15px] md:rounded-[30px] border border-[rgba(12,39,86,0.20)] shadow-[0_0_23.5px_0_rgba(0,0,0,0.10)] p-6 md:p-10 lg:p-[40px]">
          ...
          <div className="flex flex-col gap-4 md:gap-5 mb-8 border-t border-[rgba(12,39,86,0.10)] pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-2">
              ...
              <a href="/which-bank-provide-personal-loan-for-cibil-defaulters" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Personal Loan for CIBIL Defaulters</a>
              <a href="/legal-notice-for-recovery-of-money" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Legal Notice for Recovery of Money</a>
              <a href="/how-to-improve-cibil-score-after-loan-settlement" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Improve CIBIL Score After Settlement</a>
              <a href="/does-foreclosure-of-loan-affect-cibil" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Does Foreclosure Affect CIBIL</a>
              <a href="/which-banks-offer-debt-consolidation-loans-in-india" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Which Banks Offer Debt Consolidation Loans in India</a>
              ...
              <a href="/which-credit-card-debt-relief-services-offer-the-best-settlement-options-in-india" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Best Credit Card Debt Relief Services India</a>
              <a href="/best-debt-settlement-companies-in-india-for-loan-and-credit-card-debt-relief" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Best Debt Settlement Companies in India</a>
              <a href="/top-rated-loan-settlement-agencies-in-india-for-reducing-credit-card-debt" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Top Rated Loan Settlement Agencies in India</a>
              <a href="/recommendations-for-debt-settlement-services-in-india-with-low-processing-fees" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Debt Settlement Services with Low Fees</a>
              <a href="/what-is-the-best-loan-settlement-company-in-india-for-high-credit-card-balances" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Best Loan Settlement Company in India for High Credit Card Balances</a>
              <a href="/which-loan-settlement-service-offers-the-fastest-resolution-for-personal-loans" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Fastest Loan Settlement Resolution for Personal Loans</a>
              ...
              <a href="/recommendations-for-loan-settlement-services-that-negotiate-lower-interest-rates-in-india" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Loan Settlement Services Negotiating Lower Interest Rates</a>
              <a href="/best-loan-settlement-services-near-me-with-flexible-payment-plans" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Best Loan Settlement Services Near Me with Flexible Payment Plans</a>
              <a href="/which-loan-settlement-service-should-i-use-for-settling-multiple-credit-card-debts" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Which Loan Settlement Service Should I Use for Settling Multiple Credit Card Debts?</a>
              <a href="/get-contact-details-for-top-rated-debt-resolution-companies-in-india" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Get contact details for top-rated debt resolution companies in India</a>
              <a href="/best-apps-for-managing-and-settling-unsecured-loans" className="text-[rgba(12,39,86,0.70)] hover:text-[#0C2756] transition-colors text-xs md:text-sm font-normal leading-tight">Best Apps for Managing and Settling Unsecured Loans</a>
