...
// 1. 10 Synchronized FAQs (~30 words each -> ~315 words total)
const faqs = [
  {
    q: "Can KreditBee recovery agents legally call my family or reference contacts?",
    a: "No. Under RBI Digital Lending Guidelines, lenders and recovery agents are strictly prohibited from contacting third parties, scraping address books, or calling references to disclose defaults or demand repayment."
  },
  {
    q: "Which regulated entity operates the KreditBee digital lending application?",
    a: "KreditBee operates through its parent NBFC, Krazybee Services Private Limited, alongside partner banks. Both Krazybee and its recovery agents are legally bound by RBI fair collection directions."
  },
  {
    q: "What legal action stops recovery agents from creating abusive WhatsApp groups?",
    a: "Lodge an instant cyber complaint at cybercrime.gov.in under IT Act Section 66E and BNS Section 356(2), then escalate to Krazybee's Principal Nodal Officer and the RBI Integrated Ombudsman."
  },
  {
    q: "Are KreditBee recovery agents allowed to visit my home without notice?",
    a: "No. Doorstep visits without written notice or outside 8:00 AM to 7:00 PM are barred. Visiting agents must display official agency identity cards and Krazybee authorization letters."
  },
  {
    q: "How should I respond to a Section 25 NACH bounce legal notice?",
    a: "Serve a formal legal reply within 30 days demonstrating genuine financial hardship. Proving lack of fraudulent intent refutes criminal liability and opens bilateral compromise settlement talks."
  },
  {
    q: "Can I negotiate a One-Time Settlement (OTS) directly with Krazybee Services?",
    a: "Yes. Once an unsecured personal loan defaults past 90 days into NPA status, Krazybee can approve a formal OTS, waiving accumulated penal interest and collection fees."
  },
  {
    q: "How does settling a KreditBee personal loan impact my CIBIL score?",
    a: "The bureau marks the trade line as Settled, capping late fee accrual. You can subsequently rebuild credit to 750+ within 12 to 18 months via disciplined credit habits."
  },
  {
    q: "Can KreditBee recovery agents file a police FIR or arrest me for default?",
    a: "No. Unsecured personal loan default is purely a civil dispute. The Supreme Court has ruled that police cannot intervene in loan recoveries or arrest borrowers for financial distress."
  },
  {
    q: "How do I escalate an unresolved KreditBee complaint to the RBI Ombudsman?",
    a: "If Krazybee's Grievance Officer fails to resolve your complaint within 30 days, submit an online appeal on cms.rbi.org.in with call logs, threat screenshots, and complaint copies."
  },
  {
    q: "How does CredSettle assist borrowers facing aggressive KreditBee collection agents?",
    a: "CredSettle issues statutory cease-and-desist notices to halt third-party outreach, responds to Section 25 notices, and negotiates authorized compromise settlements directly with NBFC credit committees."
  }
];
              ...
              <div className="space-y-4">
                <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-[#1886ff]">
                    ...
                    <span>Stage 1: Evidence Audit</span>
                  </div>
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                    Record threatening calls, screenshot chat messages, and demand official credentials from recovery personnel to establish an evidentiary record.
                  </p>
                </div>
                ...
                <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-[#1886ff]">
                    ...
                    <span>Stage 2: Hardship Dossier</span>
                  </div>
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                    Organize financial hardship evidence including termination letters, medical summaries, or business statements to demonstrate inability to pay.
                  </p>
                </div>
                ...
                <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-[#1886ff]">
                    ...
                    <span>Stage 3: Legal Representation</span>
                  </div>
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                    Serve a formal legal notice to Krazybee Services citing RBI Digital Lending Guidelines, notifying management of collection infractions.
                  </p>
                </div>
                ...
                <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-[#1886ff]">
                    ...
                    <span>Stage 4: Settlement Talks</span>
                  </div>
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                    Engage the NBFC nodal desk directly to eliminate accumulated penal interest, negotiating a final compromise settlement between 40% and 55%.
                  </p>
                </div>
                ...
                <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-[#1886ff]">
                    ...
                    <span>Stage 5: Sanction Letter Vetting</span>
                  </div>
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                    Verify that the sanction letter is on official Krazybee letterhead, accurately states terms, and confirms full waiver upon payment.
                  </p>
                </div>
                ...
                <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                  <div className="flex items-center gap-2 text-xs font-bold text-[#1886ff]">
                    ...
                    <span>Stage 6: Remittance &amp; NDC</span>
                  </div>
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                    Remit the settlement amount directly into Krazybee verified virtual accounts, then obtain an unconditional No Dues Certificate.
                  </p>
                </div>
              </div>
            </section>
          ...
          <aside className="space-y-5 sticky top-6">
            ...
            <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xs p-5 space-y-3">
              ...
              <p className="text-xs text-slate-600 leading-relaxed border-t border-slate-100 pt-3">
                Specialist in digital lending dispute defense, RBI Fair Practices Code enforcement, and institutional NPA compromise settlements.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xs p-5 space-y-3 text-xs text-slate-600">
              ...
              <ul className="space-y-2.5">
                ...
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                  <span><strong>RBI Compliance:</strong> Direct enforcement of central banking directions.</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                  <span><strong>Pan-India Advocacy:</strong> Dedicated digital loan settlement specialists.</span>
                </li>
              </ul>
            </div>
...
console.log("Trimmed to target word count successfully.");
