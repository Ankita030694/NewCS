...
// 1. 10 Synchronized FAQs (~35 words each -> ~350 words total)
const faqs = [
  {
    q: "Can KreditBee recovery agents legally call my family members or reference contacts?",
    a: "No. Under RBI Digital Lending Guidelines, lenders and agents are strictly barred from contacting third parties, scraping phone directories, or calling references to disclose loan defaults or demand repayment."
  },
  {
  ...
  },
  {
    ...
    a: "Lodge a complaint on the National Cyber Crime Reporting Portal (cybercrime.gov.in) under IT Act Section 66E and BNS Section 356(2), then escalate to Krazybee's Principal Nodal Officer and the RBI Integrated Ombudsman."
  },
  {
          ...
          <div className="space-y-8 md:space-y-10 min-w-0">
            ...
            >
              ...
              <ul className="space-y-2.5 text-xs sm:text-sm text-slate-700 leading-relaxed">
                <li className="flex items-start gap-2.5">
                  ...
                  <span><strong>Regulated Corporate Structure:</strong> KreditBee operates through Krazybee Services Private Limited, a Systemically Important NBFC governed strictly by RBI lending directions.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span><strong>Total Prohibition on Contact Scraping:</strong> Accessing address books or calling family members without consent violates RBI Digital Lending Guidelines and the IT Act.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span><strong>Strict Operational Timing Bounds:</strong> Telephonic recovery outreach and physical home visits are legally restricted to 8:00 AM through 7:00 PM.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span><strong>Zero Criminal Exposure for Genuine Default:</strong> Personal loan delinquency is a civil contractual breach; lenders cannot initiate arrests for financial distress.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span><strong>Section 25 NACH Statutory Defense:</strong> Auto-debit bounce notices require timely legal representation within 30 days to establish bona fide financial hardship.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span><strong>Exemption from SARFAESI Seizure:</strong> Unsecured digital credit facilities carry no asset charge, making arbitrary property attachment legally impermissible.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span><strong>Direct OTS Compromise Window:</strong> Non-Performing Assets past 90 days qualify for commercial settlements at 40% to 55% of total claims.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span><strong>Structured 3-Tier Escalation:</strong> Harassment is reported progressively to Krazybee GRO, the Principal Nodal Officer, and the RBI Integrated Ombudsman.</span>
                </li>
              </ul>
            </div>
            ...
            <section id="npa-dynamics" className="scroll-target bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 md:p-9 shadow-xs space-y-5">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                KreditBee provides short-term unsecured personal loans backed by Krazybee Services Private Limited, an RBI-registered Systemically Important Non-Banking Financial Company (NBFC-ND-SI), alongside partner banks. When personal loan installments remain unpaid, the loan progresses through Special Mention Account stages: SMA-0 (1 to 30 days), SMA-1 (31 to 60 days), and SMA-2 (61 to 90 days). Upon crossing the 90-day delinquency threshold, the facility is formally classified as a Non-Performing Asset (NPA).
              </p>

              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Central banking prudential norms require NBFCs to maintain dedicated Tier-1 provisioning against unsecured NPAs. This regulatory cost creates a strong financial rationale for Krazybee to accept structured One-Time Settlements (OTS) rather than funding prolonged recovery agency contracts. Furthermore, because digital micro-advances are unsecured, lenders have no collateral rights under the SARFAESI Act, barring arbitrary property seizure without civil court decrees.
              </p>
            </section>
            ...
            <section id="financial-math" className="scroll-target bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 md:p-9 shadow-xs space-y-5">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Delinquent digital loan balances escalate rapidly due to penal interest, bounce penalties, and processing surcharges. An original disbursement of ₹1,00,000 can reach ₹1,65,000 within months. Strategic dispute negotiation isolates the true principal disbursed from inflated charges. Once an account reaches 180 days of default, lenders frequently approve compromise settlements between 40% and 55% of the total ledger balance.
              </p>
            ...
            <section id="comparison-matrix" className="scroll-target bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 md:p-9 shadow-xs space-y-5">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Comparing available debt relief options provides clarity on financial outflows, harassment cessation, and legal finality for defaulted KreditBee loan accounts.
              </p>
            ...
            <section id="cibil-impact" className="scroll-target bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 md:p-9 shadow-xs space-y-5">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                The TransUnion CIBIL score weights repayment history at 35%, credit utilization at 30%, credit age at 15%, credit mix at 10%, and inquiries at 10%. Defaulting past 90 days causes a rapid 120 to 180 point drop. A formal settlement updates the status to Settled, stopping overdue fee accumulation. Borrowers can subsequently utilize Section 21 of the Credit Information Companies (Regulation) Act (CICRA 2005) or clear the residual waiver to convert the entry from Settled to Closed, restoring prime scores within 12 to 18 months.
              </p>
            </section>
...
console.log("Files updated with calibrated content.");
