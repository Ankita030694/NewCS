...
const stages = [
  {
    ...
    points: ['Sanction letter review', 'CGFSEL coverage check', 'Penal interest audit', 'Co-borrower liability'],
    badge: 'STAGE 1: AUDIT'
  },
  {
    num: '02',
    ...
    sub: 'UNEMPLOYMENT PROOF',
    points: ['Placement gap records', 'Income &amp; bank deficits', 'Health or family crisis', 'Bona fide distress proof'],
  ...
  },
  {
    ...
    points: ['Sec 25 PSSA defense', 'Sec 138 NI Act reply', 'RBI anti-harassment', 'Protect parent co-borrower'],
  ...
  },
  {
    ...
    points: ['Stressed asset filing', '35% - 55% haircut math', '100% penal fee waiver', 'IBA guideline petition'],
  ...
  },
  {
    ...
    points: ['Official sanction check', 'No future claim clause', 'Parent guarantee release', 'Payment tranche schedule'],
  ...
  },
  {
    ...
    sub: 'DISCHARGE &amp; NDC',
    points: ['Direct bank payment', 'Clean No Dues Cert', 'Release collateral/guarantee', 'CIBIL record update'],
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 65)">
    ...
    <text x="155" y="23" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">LEGAL &amp; STUDENT DEBT RESOLUTION FRAMEWORK</text>
  </g>

  <text x="110" y="160" fill="#ffffff" font-size="44" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">EDUCATION LOAN SETTLEMENT PROCESS</text>
  <text x="110" y="202" fill="#94a3b8" font-size="20" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">6-Stage Strategic Framework for Student Debt Compromise, CGFSEL Guidelines &amp; Co-Borrower Protection</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">35% to 55% Haircut Range</text>
    </g>
    ...
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">CO-BORROWER / PARENT</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Full CIBIL Protection &amp; Discharge</text>
    </g>
    ...
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">CGFSEL &amp; NON-COLLATERAL</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Zero Tangible Asset Risk</text>
    </g>
  </g>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      ...
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">IBA Model Educational Loan Scheme • CGFSEL Scheme • Section 128 Indian Contract Act 1872 • Section 25 PSSA • CICRA 2005 • RBI Fair Practices Code</text>
    </g>
...
const outputPath = path.join(outputDir, 'education-loan-settlement.jpg');

sharp(Buffer.from(svg))
  .jpeg({ quality: 95, chromaSubsampling: '4:4:4' })
  .toFile(outputPath)
  .then(() => {
    console.log('High quality 16:9 education loan infographic generated successfully at:', outputPath);
  })
  .catch(err => {
