...
const stages = [
  {
    ...
    name: 'Docket Audit',
    color: '#06b6d4',
    sub: 'CASE &amp; WARRANT AUDIT',
    points: [
      'Examine Section 138 NI court docket',
      'Verify summons tracking &amp; service',
      'Check if NBW was unendorsed',
      'Obtain e-Courts CNR &amp; order sheets'
    ],
    badge: 'STAGE 1: AUDIT'
  },
  {
    ...
    name: 'Surety &amp; Dossier',
    color: '#3b82f6',
    sub: 'BAIL PREPARATION',
    points: [
      'Collate local solvent surety proofs',
      'Prepare medical &amp; job hardship proof',
      'Draft personal bail bond under Sec 70',
      'Secure address &amp; identity KYC docs'
    ],
    badge: 'STAGE 2: SURETY'
  },
  {
    num: '03',
    name: 'Recall Petition',
    color: '#8b5cf6',
    sub: 'MAGISTRATE COURT FILING',
    points: [
      'Draft urgent Sec 70(2) CrPC petition',
      'Cite non-willful absence grounds',
      'Attach Supreme Court NBW guidelines',
      'Furnish undertaking for trial appearance'
    ],
    badge: 'STAGE 3: RECALL'
  },
  {
    num: '04',
    name: 'Surrender &amp; Bail',
    ...
    sub: 'COURT SURRENDER',
    points: [
      'Appearance before trial Magistrate',
      'Furnish personal bond &amp; surety',
      'Secure formal NBW recall order',
      'Transmit stay/order to police station'
    ],
    badge: 'STAGE 4: BAIL GRANTED'
  },
  {
    num: '05',
    ...
    sub: 'BANK COMPROMISE',
    points: [
      'Engage bank legal &amp; credit panel',
      'Waive penal interest &amp; legal fees',
      'Negotiate 40% to 55% settlement',
      'Obtain written OTS sanction letter'
    ],
    badge: 'STAGE 5: SETTLEMENT'
  },
  {
    num: '06',
    name: 'Compounding &amp; NDC',
    color: '#14b8a6',
    sub: 'DISMISSAL &amp; CLOSURE',
    points: [
      'File Section 147 compounding petition',
      'Trial court quashes NBW &amp; case',
      'Receive official No Dues Certificate',
      'Update CIBIL to Closed status'
    ],
    badge: 'STAGE 6: DISMISSAL'
  }
];
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 60)">
    ...
    <text x="175" y="27" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">CRIMINAL PROCEDURE &amp; SECTION 138 NI ACT DEFENSE FRAMEWORK</text>
  </g>

  <!-- Main H1 Title -->
  <text x="110" y="160" fill="#ffffff" font-size="42" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">NON-BAILABLE WARRANT (NBW) RECALL PROTOCOL</text>

  <!-- Subtitle -->
  <text x="110" y="202" fill="#94a3b8" font-size="19" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Section 70(2) CrPC Recall, High Court Section 482 Quashing, Surrender Bail &amp; Section 147 Compounding</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">MAGISTRATE COURT REMEDY</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Section 70(2) Recall Petition</text>
    </g>

    <!-- Pill 2: Arrest Protection -->
    <g transform="translate(435, 0)">
      <rect width="395" height="60" rx="14" fill="#0f2348" stroke="#ef4444" stroke-width="1.2" />
      <circle cx="32" cy="30" r="14" fill="#ef4444" fill-opacity="0.2" />
      <text x="32" y="35" text-anchor="middle" fill="#f87171" font-size="16" font-weight="900">✓</text>
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">ARREST SHIELD PROTOCOL</text>
      <text x="60" y="47" fill="#f87171" font-size="17" font-weight="800">Immediate Surrender &amp; Bail</text>
    </g>

    <!-- Pill 3: High Court Quashing -->
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">HIGH COURT INTERVENTION</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Section 482 CrPC NBW Stay</text>
    </g>

    <!-- Pill 4: Case Compounding -->
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">COMPLETE DISCHARGE</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Section 147 NI Compounding</text>
    </g>
  </g>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      <text x="0" y="18" fill="#60a5fa" font-size="12" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="800" letter-spacing="1.2">STATUTORY AUTHORITIES &amp; SUPREME COURT PRECEDENTS:</text>
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Section 70(2) &amp; 482 CrPC, 1973 • Section 72 &amp; 528 BNSS, 2023 • Section 138 &amp; 147 NI Act, 1881 • Inder Mohan Goswami (2007) SC • Raghuvansh Dewanchand (2012) SC</text>
    </g>
...
const outputPath = path.join(__dirname, '../public/images/infographics/non-bailable-warrant-cheque-bounce-loan.jpg');

sharp(Buffer.from(svg))
  .jpeg({ quality: 95, chromaSubsampling: '4:4:4' })
  .toFile(outputPath)
  .then(() => {
    console.log('NBW infographic generated successfully at:', outputPath);
  })
  .catch(err => {
