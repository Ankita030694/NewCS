...
const stages = [
  {
    ...
    color: '#06b6d4',
    sub: 'STATEMENT AUDIT',
    points: ['Kotak PL &amp; 811 ledger audit', 'Penal surcharge extraction', 'Unbundled compounding GST', 'Core unamortized principal'],
    badge: 'STAGE 1: AUDIT'
  },
  {
    num: '02',
    ...
    points: ['Income loss &amp; layoff documents', 'Medical crisis records', 'Bank account statements', 'Bona fide hardship petition'],
  ...
  },
  {
    ...
    points: ['Kotak Circle Stressed Asset Desk', 'Principal Nodal Officer petition', 'Bypassing recovery telecallers', 'Stopping unauthorized visits'],
  ...
  },
  {
    ...
    points: ['100% penal interest waiver', '40% to 55% principal haircut', 'Phoenix ARC transfer shield', 'Sole arbitration challenge'],
  ...
  },
  {
    ...
    points: ['Official Kotak letterhead check', 'Zero residual balance clause', 'Legal notice withdrawal terms', 'Structured tranche deadlines'],
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 60)">
    ...
    <text x="175" y="27" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">INSTITUTIONAL KOTAK MAHINDRA DEBT RESOLUTION &amp; LEGAL RECOVERY FRAMEWORK</text>
  </g>

  <!-- Main H1 Title -->
  <text x="110" y="160" fill="#ffffff" font-size="42" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">KOTAK MAHINDRA BANK LOAN SETTLEMENT PROCESS</text>

  <!-- Subtitle -->
  <text x="110" y="202" fill="#94a3b8" font-size="19" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">811 Digital Credit &amp; Personal Loans • Phoenix ARC Defense • OTS Concession &amp; Official NDC</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <!-- Pill 3: Phoenix ARC &amp; Arbitration Defense -->
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">DEBT ASSIGNMENT &amp; LEGAL SHIELD</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Phoenix ARC &amp; Arbitration Defense</text>
    </g>
    ...
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Official Kotak No Dues Certificate</text>
    </g>
  </g>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      ...
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Kotak Mahindra Bank Stressed Asset Policy • RBI Master Directions on Stressed Assets • SARFAESI Act Section 31(g) • Section 21 CICRA 2005</text>
    </g>
...
const outputPath = path.join(__dirname, '../public/images/infographics/kotak-mahindra-bank-loan-settlement.jpg');
