        ...
        <div className="grid grid-cols-1 lg:grid-cols-[240px_minmax(0,1fr)_280px] xl:grid-cols-[260px_minmax(0,1fr)_300px] 2xl:grid-cols-[280px_minmax(0,1fr)_320px] gap-5 xl:gap-6 items-start">
          ...
          <div className="space-y-10 min-w-0">
            ...
            <section id="step-by-step-settlement-sop" className="scroll-target space-y-5">
              ...
              <p className="text-sm md:text-base text-slate-700 leading-relaxed">
                Following this structured 6-stage Standard Operating Procedure ensures commercial liabilities are resolved lawfully while shielding company leadership from persistent personal exposure.
              </p>
            ...
            <section id="statutory-notice-defense" className="scroll-target space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700 leading-relaxed">
                During loan default, lenders utilize various legal instruments. Understanding statutory defenses empowers business owners to protect their commercial rights and avert unnecessary litigation.
              </p>
            ...
            <section id="three-tier-escalation" className="scroll-target space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700 leading-relaxed">
                When recovery branches stall compromise negotiations or engage in harassment, borrowers can utilize the Reserve Bank of India statutory grievance framework to enforce fair resolution standards.
              </p>
              ...
              <div className="space-y-4 text-xs md:text-sm text-slate-700 leading-relaxed">
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    When internal bank mechanisms fail to resolve legitimate grievances within 30 days, borrowers can file a statutory complaint through the RBI Integrated Ombudsman portal citing violations of the Fair Practices Code or unjustified delays in issuing settlement documentation.
                  </p>
                </div>
              </div>
            </section>
...
console.log('BusinessLoanSettlementProcessClient.tsx updated with paragraph style');
