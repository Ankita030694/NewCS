...
const stages = [
  {
    ...
    name: 'BGV &amp; Debt Audit',
    color: '#06b6d4',
    sub: 'PORTFOLIO RISK AUDIT',
    points: [
      'Screening agency scope check',
      'Penal interest inflation isolated',
      'Civil vs statutory notice audit',
      'Employment policy verification'
    ],
    badge: 'STAGE 1: AUDIT'
  },
  {
    num: '02',
    name: 'Workplace Shield',
    color: '#3b82f6',
    sub: 'NODAL REPRESENTATION',
    points: [
      'Cease-and-desist to lender',
      'Halt calls to office switchboard',
      'Stop unauthorized HR visits',
      'Enforce RBI privacy mandates'
    ],
    badge: 'STAGE 2: SHIELD'
  },
  {
    num: '03',
    name: 'Hardship Dossier',
    color: '#8b5cf6',
    sub: 'EVIDENCE DOSSIER',
    points: [
      'Layoff or salary delay proof',
      'Medical emergency records',
      'Bank cashflow distress proofs',
      'Bona fide hardship validation'
    ],
  ...
  },
  {
    ...
    color: '#f59e0b',
    sub: '40%-55% COMPROMISE',
    points: [
      'Direct credit committee talks',
      '100% penal surcharge waiver',
      '40% to 55% principal haircut',
      'Bypass aggressive telecallers'
    ],
  ...
  },
  {
    ...
    color: '#10b981',
    sub: 'LEGAL LETTER AUDIT',
    points: [
      'Official bank letterhead check',
      'Authorized domain email check',
      'Court notice withdrawal terms',
      'Payment tranche schedule'
    ],
  ...
  },
  {
    ...
    name: 'Closure &amp; NDC',
    color: '#14b8a6',
    sub: 'BGV IMMUNITY &amp; NDC',
    points: [
      'Direct loan account payment',
      'Official No Dues Certificate',
      'CIBIL updated to Settled/Closed',
      '100% clean BGV clearance'
    ],
...
const cardsSvg = stages
  ...
  `
    ...
    const pointsSvg = st.points
      .map(
        (pt, idx) => `
    <g transform="translate(0, ${idx * 46})">
      <circle cx="26" cy="7" r="4.5" fill="${st.color}" opacity="0.9" />
      <text x="42" y="11" fill="#e2e8f0" font-size="14" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">${pt}</text>
    </g>
  `
      )
      .join('');
    ...
    <g>
      ...
      <line x1="${x + 20}" y1="${cardY + 92}" x2="${x + cardWidth - 20}" y2="${cardY + 92}" stroke="rgba(255,255,200,0.08)" stroke-width="1" />
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 60)">
    <!-- Official CredSettle Vector Wordmark with Encased Corner Brackets -->
    ...
    <text x="195" y="28" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">INSTITUTIONAL IT EMPLOYEE DEBT DEFENSE &amp; BGV CLEARANCE</text>
  </g>

  <!-- Main H1 Title -->
  <text x="110" y="160" fill="#ffffff" font-size="40" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">IT MNC JOB BGV &amp; LOAN DEFAULT ROADMAP</text>

  <!-- Subtitle -->
  <text x="110" y="202" fill="#94a3b8" font-size="18.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Corporate Screening Policies, Civil Default vs Criminal Record &amp; Career Protection Architecture</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">BGV SCREENING SCOPE</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">General IT Roles Exclude Credit</text>
    </g>

    <!-- Pill 2: Civil vs Criminal -->
    <g transform="translate(435, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">CIVIL CONTRACT DEFAULT</text>
      <text x="60" y="47" fill="#34d399" font-size="17" font-weight="800">Zero Criminal Record / No FIR</text>
    </g>

    <!-- Pill 3: Workplace Harassment Protection -->
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">WORKPLACE PROTECTION</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Strict RBI Fair Practices Shield</text>
    </g>
    ...
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">FINAL LEGAL RESOLUTION</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Authentic Bank No Dues Cert</text>
    </g>
  </g>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      ...
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">RBI Master Direction on Recovery Conduct • Section 25 PSSA 2007 • Section 138 NI Act • Supreme Court TRF / Perkins Arbitrator Rulings • CICRA 2005</text>
    </g>
...
const outputPath = path.join(__dirname, '../public/images/infographics/background-verification-for-it-job-loan-default.jpg');

sharp(Buffer.from(svg))
  .jpeg({ quality: 95, chromaSubsampling: '4:4:4' })
  .toFile(outputPath)
  .then((info) => {
    console.log(`Success: Generated 16:9 infographic at ${outputPath} (${info.width}x${info.height}, ${info.size} bytes)`);
  })
  .catch((err) => {
    console.error('Error rendering infographic:', err);
    process.exit(1);
  });
