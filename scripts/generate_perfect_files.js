...
const faqs = [
  {
    ...
    a: 'The business loan settlement process is a formal compromise mechanism where a distressed enterprise negotiates with lenders to pay a reduced lump sum, typically 40% to 60% of outstanding principal, extinguishing the commercial liability and securing an unconditional No Dues Certificate.'
  },
  {
    q: 'How does an MSME loan restructuring differ from a One Time Settlement (OTS)?',
    a: 'MSME loan restructuring modifies repayment terms by extending tenures or adjusting interest rates while keeping 100% of the principal debt active. In contrast, an OTS permanently waives accumulated interest, penal charges, and a portion of principal for an immediate final settlement.'
  },
  {
    q: 'Are directors personally liable for unsecured business loan defaults?',
    a: 'Directors are only personally liable if they executed personal guarantees or signed indemnity agreements. In private limited entities without personal guarantees, director liability remains legally separated from corporate debt under the Companies Act 2013 corporate veil doctrine.'
  },
  {
    q: 'Can a sole proprietor settle business debt without losing personal assets?',
    a: 'Yes. Because sole proprietorships lack separate legal entity status, negotiating a structured OTS prevents lenders from initiating civil execution suits against personal residential properties, resolving unsecured commercial liabilities cleanly through negotiated compromise.'
  },
  {
    q: 'What percentage waiver can an enterprise negotiate during a business loan OTS?',
    a: 'Enterprises facing verifiable commercial insolvency typically secure 100% waivers on penal interest and compound levies, alongside a 35% to 60% waiver on core principal balances, depending on asset coverage and credit committee discretion.'
  },
  {
    q: 'Can banks initiate insolvency or NCLT proceedings for unsecured business loans?',
    a: 'Under Section 4 of the Insolvency and Bankruptcy Code (IBC), financial creditors can approach the NCLT only if the corporate default exceeds ₹1 Crore. For smaller MSME debts, lenders must rely on civil recovery suits or DRT.'
  },
  {
    q: 'How does a business loan settlement impact the commercial CIBIL rank and director score?',
    a: 'The commercial credit report reflects the loan as Settled, temporarily lowering Company Credit Report (CMR) ranks. However, settling halts negative Days Past Due escalation, allowing businesses and guarantors to initiate credit rehabilitation after 12 to 24 months.'
  },
  {
    q: 'What legal notices do banks issue during business loan defaults?',
    a: 'Lenders commonly issue loan recall notices, Section 138 Negotiable Instruments Act notices for security cheques, Section 25 Payment and Settlement Systems Act notices for NACH mandate dishonour, and Section 21 Arbitration invocation notices under the 1996 Act.'
  },
  {
    q: 'How are personal guarantees discharged after completing a business loan settlement?',
    a: 'The formal settlement sanction letter must include explicit covenants discharging all personal and corporate guarantors under Section 133 of the Indian Contract Act 1872, accompanied by the physical return of original title documents and undated security cheques.'
  },
  {
    q: 'Can business debt sold to an Asset Reconstruction Company (ARC) be settled?',
    a: 'Yes. ARCs acquire non-performing business loans at substantial discounts from primary banks under SARFAESI Section 5, making them highly flexible to accept aggressive OTS proposals yielding 50% to 70% total debt waivers for immediate liquidity.'
  }
];
          ...
          <div className="space-y-10 min-w-0">
            ...
            >
              ...
              <p className="text-xs md:text-sm text-slate-700 leading-relaxed font-normal">
                When enterprise revenue evaporates due to macroeconomic volatility, servicing unsecured business credit lines becomes unviable. Indian statutory frameworks offer structured compromise mechanisms to resolve commercial debt lawfully.
              </p>
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Unsecured business loans carry zero physical collateral, preventing banks from invoking summary property attachment under SARFAESI Act.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span>RBI 90-day NPA classification mandates steep Tier-1 capital provisioning, motivating credit committees to accept One Time Settlements.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span>Substantial waivers of 40% to 60% on principal balances and 100% on penal charges are standard in bona fide commercial hardship cases.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span>Director personal guarantees must be explicitly discharged under Section 133 of the Indian Contract Act to protect personal assets.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span>Statutory notices under Section 138 NI Act and Section 25 PSSA require structured legal replies within limitation deadlines.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span>Unilateral arbitrator appointments by lenders are challengeable under Supreme Court rulings in Perkins Eastman and TRF Limited.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span>MSME loan restructuring differs from OTS by extending tenures rather than eliminating outstanding debt liabilities.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
            ...
            <section id="debt-economics-npa" className="scroll-target space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700 leading-relaxed">
                Unsecured business loans and commercial credit lines represent high-risk exposures for Indian commercial banks and NBFCs. When an enterprise encounters acute liquidity stress, supply chain disruption, or debtor default, repayment pipelines collapse. Under the Reserve Bank of India Prudential Framework for Resolution of Stressed Assets, accounts are tracked through Special Mention Account buckets: SMA-0 (1-30 days overdue), SMA-1 (31-60 days overdue), and SMA-2 (61-90 days overdue).
              </p>
              <p className="text-sm md:text-base text-slate-700 leading-relaxed">
                On the 91st day of continuous delinquency, the account is classified as a Non-Performing Asset (NPA). This triggers mandatory Tier-1 capital provisioning of 15% to 100% against bank balance sheets. Because unsecured facilities carry no registered mortgage or tangible collateral, lenders cannot invoke summary asset attachment under SARFAESI Act 2002. Consequently, banks recognize that prolonged civil litigation yields poor returns, making a commercial One Time Settlement (OTS) their most prudent recovery strategy.
              </p>
            </section>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-xs md:text-sm text-slate-700 leading-relaxed pl-10">
                    Legal counsel reviews sanction letters and ledgers to identify illegal penal charges, improper interest capitalization, and whether director guarantees were executed with limited liability covenants.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-xs md:text-sm text-slate-700 leading-relaxed pl-10">
                    The enterprise compiles audited balance sheets, declining GST filings, customer default records, and cash deficit statements to prove bona fide commercial insolvency to the bank.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-slate-900">Stage 3: Statutory Legal Notice Defense</h3>
                  </div>
                  <p className="text-xs md:text-sm text-slate-700 leading-relaxed pl-10">
                    When lenders issue Section 138 NI Act or Section 25 PSSA notices for bounced cheques or mandates, counsel files statutory replies within 15-30 days to prevent prosecution.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-slate-900">Stage 4: Credit Committee Bilateral Representation</h3>
                  </div>
                  <p className="text-xs md:text-sm text-slate-700 leading-relaxed pl-10">
                    Formal OTS proposals are submitted to the bank Stressed Asset Branch, demonstrating that a 40% to 60% cash recovery exceeds the net present value of lengthy civil litigation.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-slate-900">Stage 5: Settlement Sanction Letter Vetting</h3>
                  </div>
                  <p className="text-xs md:text-sm text-slate-700 leading-relaxed pl-10">
                    Attorneys review the bank formal OTS sanction letter to verify unconditional waiver terms, payment schedules, and explicit guarantor discharge covenants under Section 133 of the Indian Contract Act.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-slate-900">Stage 6: Direct Remittance &amp; No Dues Certificate</h3>
                  </div>
                  <p className="text-xs md:text-sm text-slate-700 leading-relaxed pl-10">
                    The compromise amount is remitted directly into the bank loan account via RTGS, followed by obtaining an unconditional No Dues Certificate and updated credit bureau reporting.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="statutory-notice-defense" className="scroll-target space-y-4">
              ...
              <p className="text-sm md:text-base text-slate-700 leading-relaxed">
                During default, lenders utilize various legal instruments. Understanding statutory defenses empowers business owners to protect their commercial rights.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2.5">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Applies when NACH auto-debit mandates dishonor. The legal defense establishes lack of fraudulent intent, demonstrating default arose from temporary commercial illiquidity rather than criminal conduct.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2.5">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Invoked for bounced security cheques. Defense asserts that blank cheques held as collateral do not constitute discharge of existing liquidated debt under Supreme Court precedents.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2.5">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Lenders often appoint unilateral sole arbitrators. Under Supreme Court rulings in Perkins Eastman and TRF Ltd, unilateral appointments are invalid under Section 12(5), halting biased proceedings.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2.5">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Debt Recovery Tribunal claims under Section 19 RDBFI Act apply exclusively to debts exceeding ₹20 Lakhs. The RBI Fair Practices Code protects borrowers from third-party harassment and coercive recovery tactics.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs md:text-sm">
                <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 text-xs leading-relaxed">
                    Submit complaints directly to the Bank Internal Grievance Redressal Officer regarding unfair charges, agent harassment, or unresponsive branch management.
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 text-xs leading-relaxed">
                    Escalate deadlocked settlement discussions to the Bank Principal Nodal Officer at zonal headquarters for credit committee compromise approvals.
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 text-xs leading-relaxed">
                    File statutory complaints through the RBI Integrated Ombudsman Scheme for Fair Practices Code violations or failure to release title deeds.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs md:text-sm">
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Enterprises holding multiple unsecured digital loans face simultaneous cross-defaults. Resolving these requires synchronized bilateral negotiations, prioritizing lenders with imminent provisioning deadlines.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    In Private Limited companies facing client loss, corporate limited liability shields directors. Where personal guarantees were signed, compromise agreements must include complete guarantor indemnification.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Sole proprietors have no separate legal identity, exposing personal assets to civil claims. Securing an OTS eliminates debt before lenders obtain civil execution decrees against residential properties.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    When banks sell bad loans to Asset Reconstruction Companies under SARFAESI Section 5 at deep discounts, ARCs readily accept aggressive OTS offers yielding 50% to 70% debt waivers.
                  </p>
                </div>
              </div>
            </section>
...
console.log('BusinessLoanSettlementProcessClient.tsx written');
