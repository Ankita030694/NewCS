...
const stages = [
  {
    ...
    color: '#06b6d4',
    sub: 'STATEMENT AUDIT',
    points: ['IDFC PL &amp; digital credit audit', 'Penal charge extraction', 'Compounding GST unbundling', 'Core unamortized principal'],
    badge: 'STAGE 1: AUDIT'
  },
  {
    num: '02',
    ...
    points: ['Income disruption &amp; layoff proof', 'Medical hospitalization records', 'Cashflow collapse evidence', 'Bona fide hardship petition'],
    badge: 'STAGE 2: DOSSIER'
  },
  {
    num: '03',
    name: 'Special Recoveries',
    color: '#8b5cf6',
    sub: 'COMMITTEE ACCESS',
    points: ['IDFC Stressed Asset Desk', 'Principal Nodal Officer petition', 'Halting telecaller harassment', 'Stopping home &amp; office visits'],
  ...
  },
  {
    ...
    points: ['100% penal surcharge waiver', 'Up to 60% principal write-off', 'Neutralizing digital summons', 'Countering sole arbitration'],
  ...
  },
  {
    ...
    points: ['Official IDFC letterhead check', 'Verified corporate email source', 'Zero residual liability clause', 'Clear tranche payment terms'],
  ...
  },
  {
    ...
    name: 'NDC &amp; Closure',
    color: '#14b8a6',
    sub: 'CBS &amp; CIBIL ZEROING',
    points: ['Direct loan account remittance', 'Official No Dues Certificate', 'CBS ledger zeroing confirmation', 'Credit bureau CIBIL update'],
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 60)">
    ...
    <text x="175" y="27" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">INSTITUTIONAL IDFC FIRST BANK DEBT RESOLUTION &amp; LEGAL RECOVERY FRAMEWORK</text>
  </g>

  <!-- Main H1 Title -->
  <text x="110" y="160" fill="#ffffff" font-size="42" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">IDFC FIRST BANK LOAN SETTLEMENT PROCESS</text>

  <!-- Subtitle -->
  <text x="110" y="202" fill="#94a3b8" font-size="19" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Retail Personal Loans &amp; Digital Consumer Debt • Digital Legal Summons Defense • 60% Haircut &amp; Official NDC</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <g transform="translate(435, 0)">
      ...
      <text x="60" y="47" fill="#34d399" font-size="17" font-weight="800">Up to 60% Haircut Concession</text>
    </g>

    <!-- Pill 3: Digital Summons & Arbitration Defense -->
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">DIGITAL SUMMONS &amp; LEGAL SHIELD</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Sec 25 PSSA &amp; ODR Defense</text>
    </g>
    ...
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Official IDFC No Dues Certificate</text>
    </g>
  </g>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      ...
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">IDFC FIRST Bank Stressed Asset Policy • RBI Master Directions on Prudential Norms • SARFAESI Act Section 31(g) • Section 21 CICRA 2005</text>
    </g>
...
const outputPath = path.join(__dirname, '../public/images/infographics/idfc-first-bank-loan-settlement.jpg');
