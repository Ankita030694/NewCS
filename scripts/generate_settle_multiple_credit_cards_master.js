...
// 10 Synchronized FAQs (~20 words answer + 8 words question = ~28 words each = ~280 words total + heading)
const faqs = [
  {
...
fs.writeFileSync(path.join(targetDir, 'page.tsx'), clean(pageCode), 'utf8');

// 2. GENERATE SettleMultipleCreditCardsClient.tsx
...
fs.writeFileSync(path.join(targetDir, 'SettleMultipleCreditCardsClient.tsx'), clean(clientCode), 'utf8');
console.log('Master files fine-tuned.');
