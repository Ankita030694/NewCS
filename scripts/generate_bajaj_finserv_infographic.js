...
const stages = [
  {
    ...
    name: 'Forensic Audit',
    color: '#06b6d4',
    sub: 'BOUNCE &amp; PENAL AUDIT',
    points: ['Bajaj statement forensic audit', 'Penal interest at 30%+ stripped', 'Repeated NACH bounce fees isolated', 'True net principal established'],
    badge: 'STAGE 1: AUDIT'
  },
  {
    num: '02',
    ...
    color: '#3b82f6',
    sub: 'INSOLVENCY DOSSIER',
    points: ['Job loss / income loss proof', 'Hospitalization / medical records', 'Bank inflow statements compiled', 'Bona fide inability established'],
  ...
  },
  {
    ...
    points: ['Bypass third-party recovery vendors', 'Enforce RBI 8AM-7PM calling limits', 'Stop unauthorized workplace visits', 'Formal representation to Pune HQ'],
  ...
  },
  {
    ...
    points: ['Stressed asset desk engagement', '100% penal &amp; overdue waiver', 'No mortgage / SARFAESI leverage', '40% to 55% principal haircut'],
  ...
  },
  {
    ...
    points: ['Official letterhead verification', 'Authorized @bajajfinserv.in email', 'Tranche schedules &amp; zero balance', 'Statutory notice withdrawal clause'],
  ...
  },
  {
    ...
    name: 'Closure &amp; NDC',
    color: '#14b8a6',
    sub: 'NDC &amp; CIBIL UPDATE',
    points: ['Direct loan account remittance', 'Official No Dues Certificate', 'System ledger write-off check', 'CIBIL update to Settled / Closed'],
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 60)">
    <!-- Scaled CredSettle Vector Wordmark with Corner Brackets -->
    ...
    <text x="195" y="28" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">INSTITUTIONAL BAJAJ FINANCE DEBT RESOLUTION &amp; RECOVERY DEFENSE</text>
  </g>

  <!-- Main H1 Title -->
  <text x="110" y="160" fill="#ffffff" font-size="40" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">BAJAJ FINSERV PERSONAL LOAN SETTLEMENT ROADMAP</text>

  <!-- Subtitle -->
  <text x="110" y="202" fill="#94a3b8" font-size="18.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Halting Collection Harassment, Stripping Compounded Penalties &amp; Securing Up to 55% OTS Haircuts</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">HARASSMENT PROTECTION</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">RBI Fair Practices Enforcement</text>
    </g>
    ...
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">FINAL LEGAL CLOSURE</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Authentic No Dues Certificate</text>
    </g>
  </g>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      ...
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">RBI Master Direction for NBFCs (Fair Practices Code) • Section 25 Payment &amp; Settlement Systems Act • Section 21 Arbitration Act (Perkins Eastman) • CICRA 2005</text>
    </g>
...
const outputPath = path.join(__dirname, '../public/images/infographics/bajaj-finserv-personal-loan-settlement.jpg');
