...
const stages = [
  {
    ...
    name: 'Warrant Audit',
    color: '#06b6d4',
    sub: 'CASE &amp; COURT VERIFICATION',
    points: ['Section 138 NI / Sec 25 PSSA check', 'Examine bail bond endorsement amount', 'Identify issuing Magistrate Court', 'Verify summons service records'],
    badge: 'STAGE 1: AUDIT'
  },
  {
    num: '02',
    ...
    points: ['Prepare local surety documentation', 'Draft personal bond under Sec 71 CrPC', 'Collate identity and address proofs', 'Bail solvency verification'],
  ...
  },
  {
    ...
    color: '#8b5cf6',
    sub: 'COURT FILING',
    points: ['Draft formal Recall Application', 'Establish non-receipt of summons', 'Medical / relocation hardship grounds', 'Undertaking for future attendance'],
    badge: 'STAGE 3: FILING'
  },
  {
    num: '04',
    name: 'Court Surrender',
    color: '#f59e0b',
    sub: 'REGULAR BAIL GRANT',
    points: ['Physical / counsel court appearance', 'Furnish bail bonds before Magistrate', 'Immediate cancellation of warrant', 'Secure certified copy of bail order'],
  ...
  },
  {
    ...
    color: '#10b981',
    sub: 'DEBT SETTLEMENT',
    points: ['Engage bank legal committee', 'Contest penal interest &amp; charges', 'Negotiate 40% to 60% compromise', 'Sanction letter verification'],
  ...
  },
  {
    ...
    color: '#14b8a6',
    sub: 'CASE CLOSURE &amp; NOC',
    points: ['File Compounding under Sec 147 NI', 'Formal withdrawal of complaint', 'Receive bank No Dues Certificate', 'CIBIL status update to Closed'],
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 60)">
    ...
    <text x="175" y="27" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">CRIMINAL PROCEDURE &amp; DEBT DISPUTE DEFENSE FRAMEWORK</text>
  </g>

  <!-- Main H1 Title -->
  <text x="110" y="160" fill="#ffffff" font-size="42" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">BAILABLE WARRANT RECALL &amp; BAIL PROTOCOL</text>

  <!-- Subtitle -->
  <text x="110" y="202" fill="#94a3b8" font-size="19" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Section 71 CrPC Surety, Magistrate Court Surrender, OTS Compromise &amp; Section 147 Compounding</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">STATUTORY BAIL PROTECTION</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Mandatory Bail upon Surety</text>
    </g>

    <!-- Pill 2: Arrest Prevention -->
    <g transform="translate(435, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">POLICE VISIT PROCEDURE</text>
      <text x="60" y="47" fill="#34d399" font-size="17" font-weight="800">Zero Custody with Station Bond</text>
    </g>

    <!-- Pill 3: Warrant Recall -->
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">TRIAL COURT REMEDY</text>
    ...
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">COMPLETE LEGAL DISMISSAL</text>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      ...
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Section 71 Code of Criminal Procedure, 1973 • Section 73 Bharatiya Nagarik Suraksha Sanhita, 2023 • Section 138 &amp; 147 NI Act, 1881 • Inder Mohan Goswami (2007) SC</text>
    </g>
...
const outputPath = path.join(__dirname, '../public/images/infographics/bailable-warrant-for-loan-default.jpg');

sharp(Buffer.from(svg))
  .jpeg({ quality: 95, chromaSubsampling: '4:4:4' })
  .toFile(outputPath)
  .then(() => {
    console.log('Bailable warrant infographic generated successfully at:', outputPath);
  })
  .catch(err => {
