...
const stages = [
  {
    ...
    sub: 'LOAN &amp; GUARANTEE AUDIT',
    points: ['Sanction letter review', 'Penal interest audit', 'Personal guarantee check', 'Cash flow baseline'],
    badge: 'STAGE 1: AUDIT'
  },
  {
    num: '02',
    ...
    points: ['Audited balance sheets', 'Declining GST returns', 'Operating cash deficit', 'Bona fide distress proof'],
  ...
  },
  {
    ...
    sub: 'STATUTORY LEGAL REPLY',
    points: ['Sec 138 NI Act reply', 'Sec 25 PSSA defense', 'Sec 21 Arb challenge', 'Stop agent harassment'],
  ...
  },
  {
    ...
    points: ['Stressed asset filing', '40% - 60% haircut math', '100% penal fee waiver', 'Net present value proof'],
  ...
  },
  {
    ...
    points: ['Official sanction check', 'No future claim clause', 'Guarantor Sec 133 release', 'Payment tranche escrow'],
  ...
  },
  {
    ...
    sub: 'DISCHARGE &amp; NDC',
    points: ['Direct bank payment', 'Clean No Dues Cert', 'Return security cheques', 'CIBIL record update'],
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 65)">
    ...
    <text x="155" y="23" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">LEGAL &amp; COMMERCIAL DEBT RESOLUTION FRAMEWORK</text>
  </g>

  <!-- Main H1 Title -->
  <text x="110" y="160" fill="#ffffff" font-size="44" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">BUSINESS LOAN SETTLEMENT PROCESS</text>

  <!-- Subtitle -->
  <text x="110" y="202" fill="#94a3b8" font-size="20" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">6-Stage Strategic Framework for MSME Debt Compromise, Principal Waivers &amp; Director Asset Protection</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">CORE PRINCIPAL WAIVER</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">40% to 60% Haircut Range</text>
    </g>

    <!-- Pill 2: Penal Interest -->
    <g transform="translate(435, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">PENAL CHARGES &amp; OVERDUE</text>
      <text x="60" y="47" fill="#34d399" font-size="17" font-weight="800">100% Complete Waiver</text>
    </g>

    <!-- Pill 3: Guarantor Isolation -->
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">DIRECTOR PERSONAL GUARANTEE</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Discharged (Sec 133 Act)</text>
    </g>

    <!-- Pill 4: SARFAESI Protection -->
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">SARFAESI &amp; ATTACHMENT</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Zero Physical Collateral Risk</text>
    </g>
  </g>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      ...
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">RBI Prudential Framework 2019 • MSMED Act 2006 • Section 133 Indian Contract Act 1872 • Section 138 NI Act • Section 25 PSSA • CICRA 2005</text>
    </g>
...
const outputPath = path.join(__dirname, '../public/images/infographics/business-loan-settlement-process.jpg');

sharp(Buffer.from(svg))
  .jpeg({ quality: 95, chromaSubsampling: '4:4:4' })
  .toFile(outputPath)
  .then(() => {
    console.log('High quality 16:9 infographic generated successfully at:', outputPath);
  })
  .catch(err => {
