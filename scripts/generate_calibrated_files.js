...
const faqs = [
  {
    ...
    a: 'The business loan settlement process is a formal compromise mechanism where a distressed enterprise negotiates with lenders to pay a reduced lump sum, typically 40% to 60% of outstanding principal, extinguishing the liability with a No Dues Certificate.'
  },
  {
    q: 'How does an MSME loan restructuring differ from a One Time Settlement (OTS)?',
    a: 'MSME loan restructuring modifies repayment terms by extending tenures or adjusting interest rates while keeping 100% of the principal debt active. In contrast, an OTS permanently waives accumulated interest, penal charges, and a portion of principal for immediate closure.'
  },
  {
  ...
  },
  {
    ...
    a: 'Lenders issue loan recall notices, Section 138 Negotiable Instruments Act notices for security cheques, Section 25 Payment and Settlement Systems Act notices for NACH mandate dishonour, and Section 21 Arbitration notices under the 1996 Act.'
  },
  {
...
console.log('BusinessLoanSettlementProcessClient.tsx rewritten');
