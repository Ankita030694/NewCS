...
const stages = [
  {
    num: '01',
    name: 'Debt &amp; Case Audit',
    color: '#06b6d4',
    sub: 'LOAN FORENSIC AUDIT',
    points: ['Audit unamortized principal', 'Identify Section 138/25 notices', 'Verify summons / warrant status', 'Eliminate illegal penal charges'],
    badge: 'STAGE 1: AUDIT'
  },
  {
    num: '02',
    name: 'LOC &amp; Court Check',
    color: '#3b82f6',
    sub: 'LEGAL STATUS CHECK',
    points: ['Inspect trial court records', 'Check warrant status remotely', 'Verify LOC issuance grounds', 'Assess High Court Article 226 relief'],
    badge: 'STAGE 2: VERIFY'
  },
  {
    num: '03',
    name: 'Special PoA &amp; Dossier',
    color: '#8b5cf6',
    sub: 'AUTHORIZATION',
    points: ['Execute Special Power of Attorney', 'Apostille / consular notarization', 'Compile cross-border hardship dossier', 'Authorize legal representation'],
    badge: 'STAGE 3: DOSSIER'
  },
  {
    num: '04',
    name: 'SAMD Negotiations',
    color: '#f59e0b',
    sub: 'SETTLEMENT ADVOCACY',
    points: ['Engage Zonal Stressed Asset Desk', 'Contest compounding interest', 'Negotiate 40% to 55% OTS waiver', 'Secure single-tranche approval'],
    badge: 'STAGE 4: NEGOTIATE'
  },
  {
    num: '05',
    name: 'Sanction Letter Review',
    color: '#10b981',
    sub: 'LEGAL VALIDATION',
    points: ['Verify official bank letterhead', 'Confirm full &amp; final debt waiver', 'Ensure court case withdrawal clause', 'Validate official bank email domain'],
    badge: 'STAGE 5: SANCTION'
  },
  {
    num: '06',
    name: 'NRE/NRO Remit &amp; NDC',
    color: '#14b8a6',
    sub: 'CLOSURE &amp; NO DUES',
    points: ['Direct remittance from NRE/NRO', 'Secure official No Dues Certificate', 'Withdraw legal complaints in court', 'Update CIBIL bureau record to zero'],
...
const cardsSvg = stages.map((st, i) => {
  ...
  return `
    <g>
      ...
      <text x="${x + 80}" y="${cardY + 66}" fill="#ffffff" font-size="16" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700">${st.name}</text>
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(110, 60)">
    ...
    <text x="175" y="27" fill="#93c5fd" font-size="13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="700" letter-spacing="1.5">NRI CROSS-BORDER DEBT SETTLEMENT &amp; AIRPORT TRAVEL DEFENSE</text>
  </g>

  <!-- Main H1 Title -->
  <text x="110" y="160" fill="#ffffff" font-size="40" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" letter-spacing="-0.5">NRI UNPAID DEBT: AIRPORT TRAVEL &amp; REMOTE SETTLEMENT SOP</text>

  <!-- Subtitle -->
  <text x="110" y="202" fill="#94a3b8" font-size="19" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">Legal Realities on Airport LOCs, Section 138/25 Defenses, 40%-55% Remote OTS &amp; Complete NOC Closure</text>
  ...
  <g transform="translate(110, 255)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">AIRPORT IMMIGRATION REALITY</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Zero Arrest for Civil Default</text>
    </g>

    <!-- Pill 2: High Court LOC Quashing -->
    <g transform="translate(435, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">ARTICLE 226 HC JURISDICTION</text>
      <text x="60" y="47" fill="#34d399" font-size="17" font-weight="800">Commercial LOCs Quashed</text>
    </g>

    <!-- Pill 3: 100% Remote Resolution -->
    <g transform="translate(870, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">CROSS-BORDER ADVOCACY</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">100% Online PoA Settlement</text>
    </g>

    <!-- Pill 4: Full NDC & CIBIL Update -->
    <g transform="translate(1305, 0)">
      ...
      <text x="60" y="26" fill="#94a3b8" font-size="11" font-weight="800" letter-spacing="1">CLEAN LEGAL CLOSURE</text>
      <text x="60" y="47" fill="#ffffff" font-size="17" font-weight="800">Official NDC &amp; Case Withdrawal</text>
    </g>
  </g>
  ...
  <g transform="translate(110, 920)">
    ...
    <g transform="translate(30, 24)">
      ...
      <text x="0" y="38" fill="#cbd5e1" font-size="13.5" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="500">MHA Office Memorandums on LOCs • Viraj Chetan Shah v. Union of India (Bombay HC) • Sec 138 NI Act • Sec 25 PSSA • Article 21 &amp; 226 Constitution of India</text>
    </g>
...
const outputPath = path.join(__dirname, '../public/images/infographics/nri-returning-to-india-with-unpaid-debt.jpg');

sharp(Buffer.from(svg))
  .jpeg({ quality: 95, chromaSubsampling: '4:4:4' })
  .toFile(outputPath)
  .then(() => {
    console.log('NRI debt infographic generated successfully at:', outputPath);
  })
  .catch(err => {
