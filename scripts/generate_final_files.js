...
const faqs = [
  {
    ...
    a: 'It is a formal compromise where a distressed enterprise negotiates with lenders to pay a reduced lump sum, typically 40% to 60% of principal, resolving debt with an official No Dues Certificate.'
  },
  {
    q: 'How does an MSME loan restructuring differ from an OTS?',
    a: 'Restructuring extends repayment tenures or alters interest rates while retaining 100% of principal debt. An OTS permanently waives interest, penalties, and a portion of principal for immediate debt extinction.'
  },
  {
    q: 'Are directors personally liable for unsecured business loan defaults?',
    a: 'Directors are liable only if they executed personal guarantees. Without personal guarantees, corporate limited liability shields directors from company debt under the Companies Act 2013 corporate veil doctrine.'
  },
  {
  ...
  },
  {
    ...
    a: 'Enterprises facing verifiable insolvency typically secure 100% waivers on penal interest and fees, plus 35% to 60% waivers on core principal balances depending on credit committee approval.'
  },
  {
    q: 'Can banks initiate NCLT insolvency for unsecured business loans?',
    a: 'Under Section 4 of the Insolvency and Bankruptcy Code, financial creditors can file before NCLT only if default exceeds ₹1 Crore. Smaller MSME debts are handled via civil recovery or DRT.'
  },
  {
    q: 'How does loan settlement impact commercial CIBIL rank and director score?',
    a: 'The loan reflects as Settled, temporarily reducing CMR and CIR scores. However, it halts negative DPD escalation, enabling credit rehabilitation within 12 to 24 months.'
  },
  {
    q: 'What legal notices do banks issue during business loan defaults?',
    a: 'Lenders issue loan recall notices, Section 138 NI Act notices for security cheques, Section 25 PSSA notices for NACH bounces, and Section 21 Arbitration notices.'
  },
  {
    q: 'How are personal guarantees discharged after settlement?',
    a: 'The settlement sanction letter must include explicit covenants releasing all personal guarantors under Section 133 of the Indian Contract Act 1872, accompanied by the return of security cheques.'
  },
  {
    q: 'Can debt sold to an Asset Reconstruction Company (ARC) be settled?',
    a: 'Yes. ARCs acquire stressed loans at substantial discounts under SARFAESI Section 5, making them highly receptive to compromise settlements offering 50% to 70% waivers.'
  }
];
...
// Write BusinessLoanSettlementProcessClient.tsx
          ...
          <div className="space-y-10 min-w-0">
            ...
            >
              ...
              <p className="text-xs md:text-sm text-slate-700 leading-relaxed font-normal">
                When enterprise revenue evaporates, servicing unsecured business credit lines becomes unviable. Indian statutory frameworks offer structured compromise mechanisms to resolve commercial debt lawfully.
              </p>
              <ul className="space-y-2.5 text-xs md:text-sm text-slate-700">
                ...
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <span>Director personal guarantees must be explicitly discharged under Section 133 of the Indian Contract Act.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1886ff] flex-shrink-0 mt-0.5" />
