...
const clientFilePath = path.join(__dirname, '../src/app/credit-card-default-after-5-years/CreditCardDefaultAfter5YearsClient.tsx');
  ...
  const faqs = [
    {
      ...
      a: 'Under Articles 19 and 25 of the Limitation Act 1963, the statutory limitation period for unsecured debt recovery is 3 years from the date of default. After 5 years without written debt acknowledgment, civil suits are legally time-barred and subject to mandatory dismissal under Section 3.'
    },
    {
      q: 'What is a zombie debt in credit card collections?',
      a: 'Zombie debt refers to aged, time-barred debt that original lending banks have written off and assigned to third-party collection agencies or ARCs. These collection agencies attempt to resurrect the expired liability through phone calls, legal notices, and coercive recovery tactics.'
    },
    {
      q: 'Does making a token payment or replying to an email restart the 3-year limitation clock?',
      a: 'Yes. Under Section 18 and Section 19 of the Limitation Act 1963, any written acknowledgment of liability or partial payment resets the 3-year limitation clock from that specific date, making an otherwise expired debt legally enforceable again.'
    },
    {
      q: 'Can credit card recovery agents arrest me or send police for a 5-year-old default?',
      a: 'No. Unsecured credit card default is purely a civil contractual matter. Recovery agents have zero police powers, and the Supreme Court has ruled that debt default without initial fraudulent inducement cannot be treated as a criminal offense.'
    },
    {
      q: 'Can banks seize my house or personal assets for an aged credit card default?',
      a: 'No. Credit cards are unsecured credit facilities. Lenders cannot invoke SARFAESI Act asset attachments or property seizures without a registered mortgage and a valid, enforceable civil court decree.'
    },
    {
      q: 'Why do banks sell 5-year-old credit card defaults to Asset Reconstruction Companies (ARCs)?',
      a: 'Banks maintain 100% capital provisioning on aged non-performing assets and perform technical write-offs to clean balance sheets. They sell these delinquent loan pools to ARCs at 2% to 6% of face value to recover residual capital.'
    },
    {
      q: 'Will a 5-year-old credit card default automatically vanish from my CIBIL report?',
      a: 'No. The Limitation Act bars legal court action but does not automatically erase credit bureau records. The account remains listed as Written-Off until resolved through a formal One-Time Settlement and No Dues Certificate.'
    },
    {
      q: 'How much waiver can I negotiate for a credit card default older than 5 years?',
      a: 'Because 5-year-old defaults are time-barred and 100% provisioned, banks and ARCs frequently agree to settlements at a 75% to 90% discount on the inflated ledger balance, often resolving at a fraction of the principal.'
    },
    {
      q: 'What is the risk of ignoring legal notices for an aged credit card default?',
      a: 'Ignoring legal notices carries the risk that a lender or ARC might obtain an ex parte arbitration award or court order by falsely claiming limitation was preserved. Serving a formal statutory reply asserting the limitation bar prevents this.'
    },
    {
      ...
      >
        ...
        <div className="max-w-5xl mx-auto text-center z-10 relative">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 text-blue-100 text-xs font-bold uppercase tracking-wider mb-3">
            ...
            <span>Statutory Limitation &amp; Debt Defense Guide</span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg mb-5 md:mb-6 max-w-3xl mx-auto font-normal text-white/95 leading-relaxed">
            Navigating the legal enforceability of aged credit card defaults under the Limitation Act 1963, the 3-year statutory bar on civil recovery suits, the mechanics of Asset Reconstruction Company portfolio sales, and structured compromise settlements that permanently extinguish zombie debt while restoring your financial freedom.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <span>Resolve 5-Year Credit Card Default - Settle Legally</span>
          ...
          <div className="space-y-8 md:space-y-10 min-w-0">
            ...
            >
              <div className="flex items-center gap-2 text-xs md:text-sm font-black uppercase tracking-wider text-[#1886ff]">
                ...
                <span>EXECUTIVE SUMMARY: LEGAL REALITY OF 5-YEAR CREDIT CARD DEFAULTS</span>
              </div>
              ...
              <ul className="space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-slate-900 font-bold">The 3-Year Statutory Limitation Bar:</strong> Under Articles 19 and 25 of the Limitation Act 1963, lenders have exactly three years from the date of default to initiate civil recovery litigation in court.
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-slate-900 font-bold">Zero Enforceability on 5-Year Defaults:</strong> Once three years lapse without a written acknowledgment of debt, civil court recovery suits are time-barred and subject to mandatory dismissal under Section 3.
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-slate-900 font-bold">Section 18 Acknowledgment Traps:</strong> Signing letters, sending email admissions, or making token payments resets the three-year limitation clock, reviving an otherwise expired legal liability.
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-slate-900 font-bold">Technical Write-Off &amp; ARC Portfolio Sales:</strong> Banks provision 100% of aged defaults after 180 days and bundle them into pools sold to Asset Reconstruction Companies at 2% to 6% of face value.
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-slate-900 font-bold">The Zombie Debt Phenomenon:</strong> Third-party collection agencies acquire aged accounts and employ aggressive, unlawful tactics to intimidate borrowers into re-acknowledging time-barred claims.
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-slate-900 font-bold">Complete SARFAESI Collateral Exemption:</strong> Unsecured credit card obligations carry zero asset hypothecation, meaning lenders cannot attach or auction residential property or bank accounts without court decrees.
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-slate-900 font-bold">75% to 90% Compromise Settlement Window:</strong> Aged non-performing accounts qualify for deep compromise One-Time Settlements, allowing permanent closure for a small fraction of the ledger balance.
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#1886ff] flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-slate-900 font-bold">Permanent Discharge &amp; CIBIL Correction:</strong> Settling aged card debts secures an official No Dues Certificate and allows updating credit bureau records from Written-Off to Settled under Section 21 of CICRA.
                  </div>
                </li>
              </ul>
            </div>
            ...
            <section id="debt-economics-aged-npa" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                When an individual defaults on an unsecured credit card in India, the debt undergoes a rigorous statutory and accounting transition under Reserve Bank of India prudential guidelines. During the initial 90 days of non-payment, the card account transitions through Special Mention Account categories (SMA-0, SMA-1, and SMA-2). Once overdue past 90 days, the banking institution formally reclassifies the facility as a Non-Performing Asset (NPA). Because credit cards represent entirely unsecured lending with zero underlying asset collateral or property hypothecation, banking regulations compel the institution to maintain aggressive capital provisioning against potential default losses.
              </p>

              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                By the time an NPA remains unserviced for 180 to 365 days, commercial banks are mandated under Tier-1 capital adequacy norms to allocate 100% loss provisioning on their balance sheets. To optimize balance sheet health, reduce gross NPAs, and claim statutory tax write-offs, the bank performs a technical write-off. The obligation is moved to an off-balance sheet memorandum ledger, and after three to five years of failed internal recovery, the bank bundles thousands of delinquent accounts into aged distressed loan pools. These portfolios are assigned or sold in bulk to Asset Reconstruction Companies (ARCs) or specialized debt recovery agencies for nominal valuations, often between 2% and 6% of the gross face value. This transaction transforms the commercial economics of the debt, creating immense financial headroom for borrowers to negotiate deep, principal-compromised One-Time Settlements.
              </p>
            </section>
            ...
            <section id="settlement-math-breakdown" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Over a five-year default period, credit card balances inflate artificially due to compounding finance charges, penal interest rates reaching 42% to 48% annually, late payment levies, and recurring 18% Goods and Services Tax (GST). A cardholder who originally defaulted on a principal spend of ₹2,00,000 frequently discovers that the lender or acquiring ARC is asserting an outstanding balance exceeding ₹7,50,000 after five years. In reality, over 70% of this claim consists of uncollected penal additions, compounded monthly charges, and speculative administrative fees that hold zero legal viability in a contested forum.
              </p>

              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Because the debt is legally time-barred under the Limitation Act 1963 and the lending institution has already written off the asset while the ARC acquired the account at a steep commercial discount, realistic settlement economics diverge drastically from the inflated ledger claim. Credit committee guidelines allow complete waivers of all accumulated interest, penal surcharges, and GST levies, alongside substantial discounts on the original core principal. In typical five-year default negotiations, structured compromise settlements are achieved at 10% to 25% of the total ledger balance, translating to a settlement of ₹60,000 to ₹90,000 on a ₹7.5 Lakh demand.
              </p>
            ...
            <section id="resolution-comparison-matrix" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Borrowers facing multi-year credit card defaults possess multiple strategic alternatives, each carrying distinct legal consequences, financial requirements, and credit score ramifications. A comparative analysis ensures borrowers avoid deceptive collection traps while selecting the optimal pathway to complete debt discharge.
              </p>
                ...
                <table className="w-full text-xs md:text-sm text-left border-collapse">
                  <thead className="bg-slate-100/80 text-slate-800 font-bold uppercase text-[11px] tracking-wider border-b border-slate-200/80">
                    <tr className="divide-x divide-slate-200/80">
                      ...
                      <th className="py-3 px-4">Recovery Harassment Risk</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200/80 text-slate-700">
                    <tr className="divide-x divide-slate-200/80 hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="py-3 px-4 text-emerald-700 font-semibold">Statutory Full Discharge with NDC</td>
                      <td className="py-3 px-4 font-bold text-emerald-700">10% to 25% of Ledger Balance</td>
                      <td className="py-3 px-4">Updated to Settled; Path to 750+</td>
                    ...
                    <tr className="divide-x divide-slate-200/80 hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="py-3 px-4">Resumes upon Any Installment Default</td>
                    </tr>
                    <tr className="divide-x divide-slate-200/80 hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="py-3 px-4">Subject to Judicial Procedure</td>
                    </tr>
                    <tr className="divide-x divide-slate-200/80 hover:bg-slate-50/60 transition-colors">
                      <td className="py-3 px-4 font-bold text-slate-900">National Lok Adalat</td>
                      <td className="py-3 px-4">Binding Civil Decree (Section 21 LSA)</td>
                      <td className="py-3 px-4">35% to 55% of Principal Balance</td>
                      <td className="py-3 px-4">Settled pursuant to Lok Adalat Award</td>
                    ...
                    <tr className="divide-x divide-slate-200/80 hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="py-3 px-4 text-amber-700 font-semibold">Debt Remains Time-Barred but Open</td>
                      <td className="py-3 px-4">Zero Direct Payment (Compounding Claim)</td>
                      <td className="py-3 px-4 text-red-600 font-semibold">Perpetual Written-Off Impairment</td>
                      <td className="py-3 px-4 text-red-600 font-semibold">High; Unregulated Zombie Calls</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section id="cibil-algorithm-impact" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Credit bureau scoring engines (TransUnion CIBIL, Experian, CRIF High Mark, and Equifax) utilize multi-factor algorithms governed by specific weighting criteria: Payment History (35%), Credit Utilization Ratio (30%), Credit History Length (15%), Credit Mix (10%), and Recent Credit Inquiries (10%). When a credit card default occurs, the 35% payment history component suffers severe damage, plunging the borrower&apos;s score from prime levels (750+) down to subprime bands between 520 and 580 within 120 days.
              </p>

              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                However, mathematical score depreciation follows a recency decay curve. By Year 5, the negative weighting attributed to the historical default reduces in velocity, but the account remains indefinitely branded with derogatory status codes such as &quot;Written Off&quot; or &quot;Post-Write-Off Default.&quot; The Limitation Act prevents civil litigation but does not automatically cleanse credit bureau servers. To eliminate this permanent commercial handicap, borrowers must execute a structured compromise settlement and obtain an official No Dues Certificate. Under Section 21 of the Credit Information Companies (Regulation) Act 2005 (CICRA), the credit institution is statutorily mandated to submit updated data within 30 days, reclassifying the account from Written-Off to Settled. Cardholders can then deploy secured credit mechanisms to elevate their credit score back beyond 750 within 12 to 18 months.
              </p>
            </section>
            ...
            <section id="infographic-overview" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                This comprehensive visual schematic details the forensic verification of time-barred debts under the Limitation Act 1963, statutory anti-harassment protections under RBI Master Directions, and the precise execution stages required to secure an official No Dues Certificate with complete principal compromise.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    CredSettle conducts an exhaustive audit of your credit card statements, determining the exact date of default and confirming that no Section 18 written debt acknowledgment or partial payment occurred within the statutory three-year window, formally establishing time-barred status.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Our legal team compiles an authoritative dossier documenting the original financial hardship (job loss, business closure, or medical crisis) alongside evidence of the 5-year default timeline, establishing clear inability to pay inflated claims while asserting statutory defenses.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    We serve formal statutory notices to the lending bank, acquiring ARC, and collection agencies, citing the Limitation Act 1963 and RBI Master Directions on Recovery Agents. This immediately halts unlawful calls, workplace visits, and third-party intimidation.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Leveraging the bank&apos;s 100% loss provisioning and the ARC&apos;s low portfolio purchase cost, our negotiators engage senior credit committees to secure a deep compromise settlement, targeting 75% to 90% waivers on the gross ledger claim.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Prior to any payment, our legal team rigorously vets the formal Settlement Sanction Letter to ensure it contains explicit full-and-final release covenants, authentic bank letterhead verification, correct loan account identifiers, and absolute prohibition on future asset sales.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    The borrower remits the agreed settlement sum directly to the official bank or ARC collection account. We obtain the formal No Dues Certificate, ensure permanent card account closure, and initiate credit bureau updates under Section 21 of CICRA.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="statutory-legal-defense" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Collection agencies and asset reconstruction firms frequently dispatch aggressive demand notices to coerce cardholders into reviving expired debts. Understanding the statutory legal framework empowers borrowers to counter these measures effectively without succumbing to illegal intimidation.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Articles 19 and 25 impose a strict three-year limitation period from the date the cause of action arises for money lent or unsecured debt. Section 3 mandates that civil courts dismiss any suit instituted after the limitation period, even if the defendant fails to appear or plead limitation.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Under Section 18, a written acknowledgment of liability signed by the borrower before the three-year limitation period expires resets the statutory clock. Section 19 similarly treats partial payments. Borrowers must never sign settlement inquiry forms or make token payments without legal counsel.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Section 25 of the Payment and Settlement Systems Act 2007 and Section 138 of the Negotiable Instruments Act 1881 apply exclusively to legally enforceable debts. If a debt is time-barred by limitation, criminal proceedings for bounced instruments cannot legally be maintained.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Under landmark Supreme Court rulings in Perkins Eastman Architects and TRF Ltd., lenders cannot unilaterally appoint sole arbitrators. Furthermore, RBI Master Directions on Recovery Agents strictly prohibit verbal abuse, contacting relatives, or calling outside 8:00 AM to 7:00 PM.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="three-tier-grievance-matrix" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                When collection agencies or ARCs violate Reserve Bank of India fair practice norms on time-barred accounts, cardholders can initiate a formal 3-tier regulatory escalation to enforce their statutory rights and compel immediate compliance.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Submit a formal written complaint to the bank or ARC Principal Grievance Officer detailing harassment incidents and time-barred status. Statutory response window is 7 to 10 working days.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    If unresolved or unsatisfied within 10 days, escalate to the Principal Nodal Officer with call recordings, notice transcripts, and statutory citations. Turnaround time is 14 to 21 working days.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    File a direct statutory complaint on cms.rbi.org.in under the RBI Integrated Ombudsman Scheme 2021 for persistent harassment or recovery violations, resulting in binding regulatory directives.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="chronological-procedural-timeline" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Understanding the chronological milestones of aged credit card defaults illuminates exactly how legal rights evolve over time, showing why year 5 represents the optimal window for deep, low-cost compromise settlement.
              </p>
                ...
                <table className="w-full text-xs md:text-sm text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-200/80 text-slate-700">
                    ...
                    <tr className="divide-x divide-slate-200/80 hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="py-3 px-4">Mandatory capital provisioning; third-party agencies</td>
            ...
            <section id="real-world-debt-scenarios" className="scroll-target space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="rounded-2xl bg-white border border-slate-200/80 p-5 space-y-2 shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Salaried professionals who defaulted following unexpected corporate downsizing or debilitating healthcare emergencies. We compile hardship dossiers demonstrating bona fide insolvency, securing comprehensive interest and penal charge waivers.
                  </p>
                </div>
            ...
            <section id="frequently-asked-questions" className="scroll-target space-y-4">
              ...
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                Authoritative legal and financial answers to the most critical inquiries regarding aged credit card defaults, statutory limitation periods, recovery agent conduct, and compromise settlements.
              </p>
            ...
            <section id="regulatory-sources" className="scroll-target space-y-4 pt-4 border-t border-slate-200">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                All legal interpretations and dispute defense frameworks presented in this guide are directly derived from statutory enactments of the Parliament of India, Reserve Bank of India Master Directions, and binding judgments of the Supreme Court of India:
              </p>

              <ul className="text-xs sm:text-sm text-slate-600 space-y-1.5 list-disc pl-5 leading-relaxed">
                <li>Limitation Act 1963 - Articles 19 &amp; 25 (3-Year Statutory Limitation for Recovery of Money Lent).</li>
                <li>Limitation Act 1963 - Section 3 (Mandatory Dismissal of Time-Barred Suits) and Section 18 (Acknowledgment of Debt).</li>
                <li>Credit Information Companies (Regulation) Act 2005 (CICRA) - Section 21 (Statutory Data Accuracy Mandate).</li>
                <li>Reserve Bank of India Master Direction - Recovery Agents and Fair Practices Code (August 2022).</li>
                <li>Supreme Court of India - Perkins Eastman Architects DPC v. HSCC (India) Ltd. (Arbitrator Disqualification).</li>
                <li>Payment and Settlement Systems Act 2007 - Section 25 (Dishonour of Electronic Funds Transfer).</li>
              </ul>
...
console.log('CreditCardDefaultAfter5YearsClient.tsx written successfully');
